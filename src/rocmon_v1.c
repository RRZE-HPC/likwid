...
int
rocmon_v1_init(int numGpus, const int* gpuIds)
{
    hsa_status_t status;
...
int
rocmon_v1_setupCounters(int gid)
{
    int ret;
...
double
rocmon_v1_getResult(int gpuIdx, int groupId, int eventId)
{
    // Ensure rocmon is initialized
    if (!rocmon_initialized)
    {
...
double
rocmon_v1_getLastResult(int gpuIdx, int groupId, int eventId)
{
    // Ensure rocmon is initialized
    if (!rocmon_initialized)
    {
...
int
rocmon_v1_getEventsOfGpu(int gpuIdx, EventList_rocm_t* list)
{
    // Ensure rocmon is initialized
    if (!rocmon_initialized)
    {
...
void
rocmon_v1_freeEventsOfGpu(EventList_rocm_t list)
{
#define FREE_IF_NOT_NULL(var) if ( var ) { free( var ); var = NULL; }
...
int
rocmon_v1_switchActiveGroup(int newGroupId)
{
    int ret;
...
int
rocmon_v1_getNumberOfGroups(void)
{
...
int
rocmon_v1_getIdOfActiveGroup(void)
{
    if (!rocmon_context || !rocmon_initialized)
    {
        return -EFAULT;
...
int
rocmon_v1_getNumberOfGPUs(void)
{
    if (!rocmon_context || !rocmon_initialized)
    {
        return -EFAULT;
...
int
rocmon_v1_getNumberOfEvents(int groupId)
{
...
int
rocmon_v1_getNumberOfMetrics(int groupId)
{
    if (!rocmon_context || !rocmon_initialized || (groupId < 0) || groupId > rocmon_context->numActiveGroups)
    {
        return -EFAULT;
...
double
rocmon_v1_getTimeOfGroup(int groupId)
{
    int i = 0;
    double t = 0;
    if (!rocmon_context || !rocmon_initialized || (groupId < 0) || groupId > rocmon_context->numActiveGroups)
...
double
rocmon_v1_getLastTimeOfGroup(int groupId)
{
    int i = 0;
    double t = 0;
    if (!rocmon_context || !rocmon_initialized || (groupId < 0) || groupId > rocmon_context->numActiveGroups)
...
double
rocmon_v1_getTimeToLastReadOfGroup(int groupId)
{
    int i = 0;
    double t = 0;
    if (!rocmon_context || !rocmon_initialized || (groupId < 0) || groupId > rocmon_context->numActiveGroups)
...
char*
rocmon_v1_getEventName(int groupId, int eventId)
{
    if (!rocmon_context || !rocmon_initialized || (groupId < 0) || groupId >= rocmon_context->numActiveGroups)
    {
        return NULL;
...
char*
rocmon_v1_getCounterName(int groupId, int eventId)
{
    if (!rocmon_context || !rocmon_initialized || (groupId < 0) || groupId >= rocmon_context->numActiveGroups)
    {
        return NULL;
...
char*
rocmon_v1_getMetricName(int groupId, int metricId)
{
    if (!rocmon_context || !rocmon_initialized || (groupId < 0) || groupId >= rocmon_context->numActiveGroups)
    {
        return NULL;
...
char* 
rocmon_v1_getGroupName(int groupId)
{
    if (!rocmon_context || !rocmon_initialized || (groupId < 0) || groupId >= rocmon_context->numActiveGroups)
    {
        return NULL;
...
char*
rocmon_v1_getGroupInfoShort(int groupId)
{
    if (!rocmon_context || !rocmon_initialized || (groupId < 0) || groupId >= rocmon_context->numActiveGroups)
    {
        return NULL;
...
char*
rocmon_v1_getGroupInfoLong(int groupId)
{
    if (!rocmon_context || !rocmon_initialized || (groupId < 0) || groupId >= rocmon_context->numActiveGroups)
    {
        return NULL;
...
int
rocmon_v1_getGroups(char*** groups, char*** shortinfos, char*** longinfos)
{
    init_configuration();
    Configuration_t config = get_configuration();

    return perfgroup_getGroups(config->groupPath, "amd_gpu_v1", groups, shortinfos, longinfos);
}


int
rocmon_v1_returnGroups(int nrgroups, char** groups, char** shortinfos, char** longinfos)
{
