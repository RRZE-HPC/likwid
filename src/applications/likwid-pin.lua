...
local function examples()
    ...
    print_stdout("    Pin the application to hardware threads 0,4,5 and 6:")
    print_stdout("    $ likwid-pin.lua -c 0,4-6 ./myApp")
    print_stdout()
    print_stdout("  2. Thread list with logical thread numberings in physical cores first sorted list.")
    print_stdout("    Example usage thread list:")
    print_stdout("    $ likwid-pin.lua -c N:0,4-6 ./myApp")
    print_stdout()
    ...
    print_stdout("    Example usage expression:")
    print_stdout("    $ likwid-pin.lua -c E:N:8 ./myApp")
    print_stdout()
    ...
    print_stdout("    Example usage scatter:")
    print_stdout("    $ likwid-pin.lua -c M:scatter ./myApp")
    print_stdout()
