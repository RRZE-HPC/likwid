...
static RegisterMap haswell_counter_map[NUM_COUNTERS_HASWELL] = {
    ...
    { "CBOX0C0",   PMC17, CBOX0,    MSR_UNC_CBO_0_PERFEVTSEL0, MSR_UNC_CBO_0_CTR0,     0, 0,                     HAS_VALID_OPTIONS_CBOX                                   },
    { "CBOX0C1",   PMC18, CBOX0,    MSR_UNC_CBO_0_PERFEVTSEL1, MSR_UNC_CBO_0_CTR1,     0, 0,                     HAS_VALID_OPTIONS_CBOX                                   },
    { "CBOX1C0",   PMC19, CBOX1,    MSR_UNC_CBO_1_PERFEVTSEL0, MSR_UNC_CBO_1_CTR0,     0, 0,                     HAS_VALID_OPTIONS_CBOX                                   },
    { "CBOX1C1",   PMC20, CBOX1,    MSR_UNC_CBO_1_PERFEVTSEL1, MSR_UNC_CBO_1_CTR1,     0, 0,                     HAS_VALID_OPTIONS_CBOX                                   },
    { "CBOX2C0",   PMC21, CBOX2,    MSR_UNC_CBO_2_PERFEVTSEL0, MSR_UNC_CBO_2_CTR0,     0, 0,                     HAS_VALID_OPTIONS_CBOX                                   },
    { "CBOX2C1",   PMC22, CBOX2,    MSR_UNC_CBO_2_PERFEVTSEL1, MSR_UNC_CBO_2_CTR1,     0, 0,                     HAS_VALID_OPTIONS_CBOX                                   },
    { "CBOX3C0",   PMC23, CBOX3,    MSR_UNC_CBO_3_PERFEVTSEL0, MSR_UNC_CBO_3_CTR0,     0, 0,                     HAS_VALID_OPTIONS_CBOX                                   },
    { "CBOX3C1",   PMC24, CBOX3,    MSR_UNC_CBO_3_PERFEVTSEL1, MSR_UNC_CBO_3_CTR1,     0, 0,                     HAS_VALID_OPTIONS_CBOX                                   },
    { "UBOX0",     PMC25, UBOX,     MSR_UNC_ARB_PERFEVTSEL0,   MSR_UNC_ARB_CTR0,       0, 0,                     HAS_VALID_OPTIONS_UBOX                                   },
    { "UBOX1",     PMC26, UBOX,     MSR_UNC_ARB_PERFEVTSEL1,   MSR_UNC_ARB_CTR1,       0, 0,                     HAS_VALID_OPTIONS_UBOX                                   },
    ...
    { "MBOX0TMP0", PMC31, MBOX0TMP, 0x0,                       0x3,                    0, PCI_IMC_DEVICE_0_CH_0, EVENT_OPTION_NONE_MASK                                   },
    { "MBOX0TMP1", PMC32, MBOX0TMP, 0x0,                       0x4,                    0, PCI_IMC_DEVICE_0_CH_0, EVENT_OPTION_NONE_MASK                                   },
};

static BoxMap haswell_box_map[NUM_UNITS] = {
    [PMC]     = { MSR_PERF_GLOBAL_CTRL,     MSR_PERF_GLOBAL_STATUS,     MSR_PERF_GLOBAL_OVF_CTRL,     0, 0, 0,                     48, 0, 0 },
    [THERMAL] = { 0,                        0,                          0,                            0, 0, 0,                     8,  0, 0 },
    [FIXED]   = { MSR_PERF_GLOBAL_CTRL,     MSR_PERF_GLOBAL_STATUS,     MSR_PERF_GLOBAL_OVF_CTRL,     0, 0, 0,                     48, 0, 0 },
...
static PciDevice haswell_pci_devices[MAX_NUM_PCI_DEVICES] = {
