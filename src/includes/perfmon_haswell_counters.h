...
#define NUM_COUNTERS_HASWELL 21
#define NUM_COUNTERS_CORE_HASWELL 17
...
#define HAS_VALID_OPTIONS_PERF EVENT_OPTION_COUNT_KERNEL_MASK
...
static RegisterMap haswell_counter_map[NUM_COUNTERS_HASWELL] = {
    ...
    {"PERF0", PMC8, PERF, 0, 0, 0, 0, HAS_VALID_OPTIONS_PERF},
    {"PERF1", PMC9, PERF, 0, 0, 0, 0, HAS_VALID_OPTIONS_PERF},
    {"PERF2", PMC10, PERF, 0, 0, 0, 0, HAS_VALID_OPTIONS_PERF},
    {"PERF3", PMC11, PERF, 0, 0, 0, 0, HAS_VALID_OPTIONS_PERF},
    {"PERF4", PMC12, PERF, 0, 0, 0, 0, HAS_VALID_OPTIONS_PERF},
    {"PERF5", PMC13, PERF, 0, 0, 0, 0, HAS_VALID_OPTIONS_PERF},
    {"PERF6", PMC14, PERF, 0, 0, 0, 0, HAS_VALID_OPTIONS_PERF},
    {"PERF7", PMC15, PERF, 0, 0, 0, 0, HAS_VALID_OPTIONS_PERF},
    {"PERF8", PMC16, PERF, 0, 0, 0, 0, HAS_VALID_OPTIONS_PERF},
    /* RAPL counters */
    {"PWR0", PMC17, POWER, 0, MSR_PKG_ENERGY_STATUS, 0, 0, EVENT_OPTION_NONE_MASK},
    {"PWR1", PMC18, POWER, 0, MSR_PP0_ENERGY_STATUS, 0, 0, EVENT_OPTION_NONE_MASK},
    {"PWR2", PMC19, POWER, 0, MSR_PP1_ENERGY_STATUS,  0, 0, EVENT_OPTION_NONE_MASK},
    {"PWR3", PMC20, POWER, 0, MSR_DRAM_ENERGY_STATUS,  0, 0, EVENT_OPTION_NONE_MASK},
