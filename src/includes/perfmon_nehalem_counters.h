...
#define NEH_VALID_OPTIONS_UNCORE                                                                                                                                                   \
    EVENT_OPTION_ANYTHREAD_MASK | EVENT_OPTION_EDGE_MASK | EVENT_OPTION_INVERT_MASK | EVENT_OPTION_THRESHOLD_MASK | EVENT_OPTION_MATCH0_MASK | EVENT_OPTION_OPCODE_MASK
...
static BoxMap nehalem_box_map[NUM_UNITS] = {
    ...
    [UNCORE] = { MSR_UNCORE_PERF_GLOBAL_CTRL, MSR_UNCORE_PERF_GLOBAL_STATUS, MSR_UNCORE_PERF_GLOBAL_OVF_CTRL, -1, 0, 0, 48, 0, 0 }
};
