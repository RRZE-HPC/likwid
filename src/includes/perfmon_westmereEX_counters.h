...
static BoxMap westmereEX_box_map[NUM_UNITS] = {
    ...
    [RBOX0]    = { MSR_R0_PMON_BOX_CTRL,   MSR_R0_PMON_BOX_STATUS,   MSR_R0_PMON_BOX_OVF_CTRL,   0, 0, 0, 48, 0,                      0                     },
    [RBOX1]    = { MSR_R1_PMON_BOX_CTRL,   MSR_R1_PMON_BOX_STATUS,   MSR_R1_PMON_BOX_OVF_CTRL,   0, 0, 0, 48, 0,                      0                     },
    ...
    [CBOX0]    = { MSR_C0_PMON_BOX_CTRL,   MSR_C0_PMON_BOX_STATUS,   MSR_C0_PMON_BOX_OVF_CTRL,   0, 0, 0, 48, 0,                      0                     },
    [CBOX1]    = { MSR_C1_PMON_BOX_CTRL,   MSR_C1_PMON_BOX_STATUS,   MSR_C1_PMON_BOX_OVF_CTRL,   0, 0, 0, 48, 0,                      0                     },
    [CBOX2]    = { MSR_C2_PMON_BOX_CTRL,   MSR_C2_PMON_BOX_STATUS,   MSR_C2_PMON_BOX_OVF_CTRL,   0, 0, 0, 48, 0,                      0                     },
    [CBOX3]    = { MSR_C3_PMON_BOX_CTRL,   MSR_C3_PMON_BOX_STATUS,   MSR_C3_PMON_BOX_OVF_CTRL,   0, 0, 0, 48, 0,                      0                     },
    [CBOX4]    = { MSR_C4_PMON_BOX_CTRL,   MSR_C4_PMON_BOX_STATUS,   MSR_C4_PMON_BOX_OVF_CTRL,   0, 0, 0, 48, 0,                      0                     },
    [CBOX5]    = { MSR_C5_PMON_BOX_CTRL,   MSR_C5_PMON_BOX_STATUS,   MSR_C5_PMON_BOX_OVF_CTRL,   0, 0, 0, 48, 0,                      0                     },
    [CBOX6]    = { MSR_C6_PMON_BOX_CTRL,   MSR_C6_PMON_BOX_STATUS,   MSR_C6_PMON_BOX_OVF_CTRL,   0, 0, 0, 48, 0,                      0                     },
    [CBOX7]    = { MSR_C7_PMON_BOX_CTRL,   MSR_C7_PMON_BOX_STATUS,   MSR_C7_PMON_BOX_OVF_CTRL,   0, 0, 0, 48, 0,                      0                     },
    [CBOX8]    = { MSR_C8_PMON_BOX_CTRL,   MSR_C8_PMON_BOX_STATUS,   MSR_C8_PMON_BOX_OVF_CTRL,   0, 0, 0, 48, 0,                      0                     },
    [CBOX9]    = { MSR_C9_PMON_BOX_CTRL,   MSR_C9_PMON_BOX_STATUS,   MSR_C9_PMON_BOX_OVF_CTRL,   0, 0, 0, 48, 0,                      0                     },
    [WBOX]     = { MSR_W_PMON_BOX_CTRL,    MSR_W_PMON_BOX_STATUS,    MSR_W_PMON_BOX_OVF_CTRL,    0, 0, 0, 48, 0,                      0                     },
    [WBOX0FIX] = { MSR_W_PMON_BOX_CTRL,    MSR_W_PMON_BOX_STATUS,    MSR_W_PMON_BOX_OVF_CTRL,    0, 0, 0, 48, 0,                      0                     },
    [UBOX]     = { MSR_U_PMON_GLOBAL_CTRL, MSR_U_PMON_GLOBAL_STATUS, MSR_U_PMON_GLOBAL_OVF_CTRL, 0, 0, 0, 48, 0,                      0                     },
};
