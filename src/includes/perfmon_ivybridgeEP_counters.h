...
#define IVBEP_VALID_OPTIONS_CBOX EVENT_OPTION_EDGE_MASK | EVENT_OPTION_THRESHOLD_MASK | EVENT_OPTION_TID_MASK | EVENT_OPTION_STATE_MASK | EVENT_OPTION_NID_MASK | EVENT_OPTION_OPCODE_MASK | EVENT_OPTION_MATCH0_MASK
#define IVBEP_VALID_OPTIONS_WBOX EVENT_OPTION_EDGE_MASK | EVENT_OPTION_THRESHOLD_MASK | EVENT_OPTION_OCCUPANCY_MASK | EVENT_OPTION_OCCUPANCY_FILTER_MASK | EVENT_OPTION_OCCUPANCY_EDGE_MASK | EVENT_OPTION_OCCUPANCY_INVERT_MASK
#define IVBEP_VALID_OPTIONS_MBOX EVENT_OPTION_EDGE_MASK | EVENT_OPTION_THRESHOLD_MASK
#define IVBEP_VALID_OPTIONS_SBOX EVENT_OPTION_EDGE_MASK | EVENT_OPTION_THRESHOLD_MASK | EVENT_OPTION_MATCH0_MASK | EVENT_OPTION_MATCH1_MASK | EVENT_OPTION_MASK0_MASK | EVENT_OPTION_MASK0_MASK
