 ...
 * =======================================================================================
 */
#ifndef PERFMON_ZEN3_COUNTERS_H
#define PERFMON_ZEN3_COUNTERS_H

#ifdef LIKWID_USE_PERFEVENT
#define NUM_COUNTERS_ZEN3 20
#else
...
static RegisterMap zen3_counter_map[NUM_COUNTERS_ZEN3] = {
    /* Fixed counters */
    ...
    {"DFC0",PMC15, MBOX0, MSR_AMD17_2_DF_PERFEVTSEL0, MSR_AMD17_2_DF_PMC0, 0, 0, EVENT_OPTION_NONE_MASK},
    {"DFC1",PMC16, MBOX0, MSR_AMD17_2_DF_PERFEVTSEL1, MSR_AMD17_2_DF_PMC1, 0, 0, EVENT_OPTION_NONE_MASK},
    {"DFC2",PMC17, MBOX0, MSR_AMD17_2_DF_PERFEVTSEL2, MSR_AMD17_2_DF_PMC2, 0, 0, EVENT_OPTION_NONE_MASK},
    {"DFC3",PMC18, MBOX0, MSR_AMD17_2_DF_PERFEVTSEL3, MSR_AMD17_2_DF_PMC3, 0, 0, EVENT_OPTION_NONE_MASK},
#ifdef LIKWID_USE_PERFEVENT
    /* Energy counters */
    {"PWR1", PMC19, POWER, 0, MSR_AMD17_RAPL_PKG_STATUS, 0, 0, EVENT_OPTION_NONE_MASK},
#else
    /* Energy counters */
    {"PWR0", PMC19, POWER, 0, MSR_AMD17_RAPL_CORE_STATUS, 0, 0, EVENT_OPTION_NONE_MASK},
    {"PWR1", PMC20, POWER, 0, MSR_AMD17_RAPL_PKG_STATUS, 0, 0, EVENT_OPTION_NONE_MASK},
#endif
};
