...
int perfmon_init_perfevent(int cpu_id)
{
    ...
    if (cpuid_info.family == ZEN3_FAMILY && (cpuid_info.model == ZEN4_RYZEN || cpuid_info.model == ZEN4_EPYC || cpuid_info.model == ZEN4_RYZEN_PRO))
    {
...
/*    }*/
    ...
    if (type != POWER && cpuid_info.family == ZEN3_FAMILY && (cpuid_info.model == ZEN4_RYZEN || cpuid_info.model == ZEN4_EPYC || cpuid_info.model == ZEN4_RYZEN_PRO))
    {
        int got_cid = 0;
        int got_slices = 0;
        int got_tid = 0;
