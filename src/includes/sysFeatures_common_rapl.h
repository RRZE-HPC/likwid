...
static inline int getset_check(
    const LikwidDevice_t device, const void *value, LikwidDeviceType type)
{
...
static inline int getset_unusedinfo_check(const LikwidDevice_t device, const void *value,
...
static inline int getset_info_check(const LikwidDevice_t device, const void *value,
    const RaplDomainInfo *info, LikwidDeviceType type)
{
    if (!info) {
        return -EINVAL;
