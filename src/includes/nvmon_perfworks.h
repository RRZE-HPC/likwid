...
#define CUDA_CALL(func, ...)                                                                       \
    do {                                                                                           \
        ...
        if (s != cudaSuccess) {                                                                    \
            ERROR_PRINT("Error: function %s failed with error: '%s' (cudaError_t=%d).",            \
                #func,                                                                             \
                cudaGetErrorString_ptr(s),                                                         \
                s);                                                                                \
            return -EPERM;                                                                         \
        }                                                                                          \
    } while (0)
...
#define CU_CALL(func, ...)                                                                         \
    do {                                                                                           \
        ...
        if (s != CUDA_SUCCESS) {                                                                   \
            ...
            ERROR_PRINT(                                                                           \
                "Error: function %s failed with error: '%s' (CUresult=%d).", #func, errstr, s);    \
            return -EPERM;                                                                         \
        }                                                                                          \
    } while (0)
#endif
...
#define NVPW_MetricsEvaluator_EvaluateToGpuValues_Params_STRUCT_SIZE                               \
    NVPA_STRUCT_SIZE(NVPW_MetricsEvaluator_EvaluateToGpuValues_Params, pMetricValues)
#endif
...
#define NVPW_CUDA_MetricsContext_Create_Params_STRUCT_SIZE                                         \
    NVPA_STRUCT_SIZE(NVPW_CUDA_MetricsContext_Create_Params, pMetricsContext)
...
#define NVPW_MetricsContext_Destroy_Params_STRUCT_SIZE                                             \
    NVPA_STRUCT_SIZE(NVPW_MetricsContext_Destroy_Params, pMetricsContext)
...
#define NVPW_MetricsContext_GetMetricNames_Begin_Params_STRUCT_SIZE                                \
    NVPA_STRUCT_SIZE(                                                                              \
        NVPW_MetricsContext_GetMetricNames_Begin_Params, hidePctOfPeakSubMetricsOnThroughputs)
...
#define NVPW_MetricsContext_GetMetricNames_End_Params_STRUCT_SIZE                                  \
    NVPA_STRUCT_SIZE(NVPW_MetricsContext_GetMetricNames_End_Params, pMetricsContext)
...
#define NVPW_MetricsContext_GetMetricProperties_Begin_Params_STRUCT_SIZE                           \
    NVPA_STRUCT_SIZE(                                                                              \
        NVPW_MetricsContext_GetMetricProperties_Begin_Params, ppOptionalRawMetricDependencies)
...
#define NVPW_MetricsContext_GetMetricProperties_End_Params_STRUCT_SIZE                             \
    NVPA_STRUCT_SIZE(NVPW_MetricsContext_GetMetricProperties_End_Params, pMetricsContext)
...
#define NVPW_MetricsContext_SetCounterData_Params_STRUCT_SIZE                                      \
    NVPA_STRUCT_SIZE(NVPW_MetricsContext_SetCounterData_Params, isolated)
...
#define NVPW_MetricsContext_EvaluateToGpuValues_Params_STRUCT_SIZE                                 \
    NVPA_STRUCT_SIZE(NVPW_MetricsContext_EvaluateToGpuValues_Params, pMetricValues)
#endif
...
#define CUpti_Profiler_Host_Initialize_Params_STRUCT_SIZE                                          \
    CUPTI_PROFILER_STRUCT_SIZE(CUpti_Profiler_Host_Initialize_Params, pHostObject)
...
#define CUpti_Profiler_Host_Deinitialize_Params_STRUCT_SIZE                                        \
...
#define CUpti_Profiler_Host_GetBaseMetrics_Params_STRUCT_SIZE                                      \
...
#define CUpti_Profiler_Host_GetSubMetrics_Params_STRUCT_SIZE                                       \
...
#define DECLARE_CUFUNC(funcname, ...)                                                              \
    CUresult __attribute__((weak)) funcname(__VA_ARGS__);                                          \
    static CUresult (*funcname##_ptr)(__VA_ARGS__);
#endif
...
#define DECLARE_CUDAFUNC(funcname, ...)                                                            \
    cudaError_t __attribute__((weak)) funcname(__VA_ARGS__);                                       \
    static cudaError_t (*funcname##_ptr)(__VA_ARGS__);
#endif
...
#define DECLARE_NVPWFUNC(funcname, ...)                                                            \
    NVPA_Status __attribute__((weak)) funcname(__VA_ARGS__);                                       \
    static NVPA_Status (*funcname##_ptr)(__VA_ARGS__);
#endif
...
DECLARE_NVPWFUNC(
    NVPW_MetricsContext_GetMetricNames_End, NVPW_MetricsContext_GetMetricNames_End_Params *params);
...
DECLARE_NVPWFUNC(NVPW_CUDA_RawMetricsConfig_Create, NVPW_CUDA_RawMetricsConfig_Create_Params *);
DECLARE_NVPWFUNC(NVPW_RawMetricsConfig_Destroy, NVPW_RawMetricsConfig_Destroy_Params *params);
DECLARE_NVPWFUNC(
    NVPW_RawMetricsConfig_BeginPassGroup, NVPW_RawMetricsConfig_BeginPassGroup_Params *params);
DECLARE_NVPWFUNC(
    NVPW_RawMetricsConfig_EndPassGroup, NVPW_RawMetricsConfig_EndPassGroup_Params *params);
...
DECLARE_NVPWFUNC(
    NVPW_RawMetricsConfig_GetConfigImage, NVPW_RawMetricsConfig_GetConfigImage_Params *params);
...
DECLARE_NVPWFUNC(
    NVPW_CounterDataBuilder_AddMetrics, NVPW_CounterDataBuilder_AddMetrics_Params *params);
...
DECLARE_NVPWFUNC(NVPW_Profiler_CounterData_GetRangeDescriptions,
    NVPW_Profiler_CounterData_GetRangeDescriptions_Params *params);
DECLARE_NVPWFUNC(
    NVPW_MetricsContext_SetCounterData, NVPW_MetricsContext_SetCounterData_Params *params);
DECLARE_NVPWFUNC(NVPW_MetricsContext_EvaluateToGpuValues,
    NVPW_MetricsContext_EvaluateToGpuValues_Params *params);
DECLARE_NVPWFUNC(
    NVPW_RawMetricsConfig_GetNumPasses, NVPW_RawMetricsConfig_GetNumPasses_Params *params);
...
DECLARE_NVPWFUNC(
    NVPW_CUDA_MetricsEvaluator_Initialize, NVPW_CUDA_MetricsEvaluator_Initialize_Params *params);
DECLARE_NVPWFUNC(NVPW_MetricsEvaluator_ConvertMetricNameToMetricEvalRequest,
...
DECLARE_NVPWFUNC(
    NVPW_CUDA_RawMetricsConfig_Create_V2, NVPW_CUDA_RawMetricsConfig_Create_V2_Params *params);
DECLARE_NVPWFUNC(
    NVPA_RawMetricsConfig_Create, const NVPA_RawMetricsConfigOptions *, NVPA_RawMetricsConfig **);

#ifndef DECLARE_CUPTIFUNC
#define DECLARE_CUPTIFUNC(funcname, ...)                                                           \
...
DECLARE_CUPTIFUNC(cuptiProfilerCounterDataImageCalculateScratchBufferSize,
    CUpti_Profiler_CounterDataImage_CalculateScratchBufferSize_Params *params);
DECLARE_CUPTIFUNC(cuptiProfilerCounterDataImageInitializeScratchBuffer,
...
DECLARE_CUPTIFUNC(
    cuptiProfilerGetCounterAvailability, CUpti_Profiler_GetCounterAvailability_Params *params);
DECLARE_CUPTIFUNC(cuptiGetResultString, CUptiResult result, const char **str);
DECLARE_CUPTIFUNC(cuptiProfilerHostInitialize, CUpti_Profiler_Host_Initialize_Params *params);
DECLARE_CUPTIFUNC(cuptiProfilerHostDeinitialize, CUpti_Profiler_Host_Deinitialize_Params *params);
DECLARE_CUPTIFUNC(
    cuptiProfilerHostGetBaseMetrics, CUpti_Profiler_Host_GetBaseMetrics_Params *params);
DECLARE_CUPTIFUNC(cuptiProfilerHostGetSubMetrics, CUpti_Profiler_Host_GetSubMetrics_Params *params);
...
static int link_perfworks_libraries(void)
{
    ...
    if (cudahome != NULL) {
        ...
        snprintf(libnvperfpath,
            sizeof(libnvperfpath),
            "%s/extras/CUPTI/lib64/libnvperf_host.so",
            cudahome);
        snprintf(libcuptipath, sizeof(libcuptipath), "%s/extras/CUPTI/lib64/libcupti.so", cudahome);
    } else {
    ...
    cuDeviceGetCount_ptr     = DLSYM_AND_CHECK(dl_perfworks_libcuda, "cuDeviceGetCount");
    ...
    cuCtxPushCurrent_ptr     = DLSYM_AND_CHECK(dl_perfworks_libcuda, "cuCtxPushCurrent");
    cuCtxSynchronize_ptr     = DLSYM_AND_CHECK(dl_perfworks_libcuda, "cuCtxSynchronize");
    cuCtxDestroy_ptr         = DLSYM_AND_CHECK(dl_perfworks_libcuda, "cuCtxDestroy");
    cuDeviceGetAttribute_ptr = DLSYM_AND_CHECK(dl_perfworks_libcuda, "cuDeviceGetAttribute");
    ...
    cudaDriverGetVersion_ptr  = DLSYM_AND_CHECK(dl_perfworks_libcudart, "cudaDriverGetVersion");
    cudaRuntimeGetVersion_ptr = DLSYM_AND_CHECK(dl_perfworks_libcudart, "cudaRuntimeGetVersion");
    ...
    NVPW_GetSupportedChipNames_ptr = DLSYM_AND_CHECK(dl_libhost, "NVPW_GetSupportedChipNames");
    ...
    if (cuda_runtime_version < 12060) {
        NVPW_MetricsContext_GetMetricProperties_Begin_ptr =
            DLSYM_AND_CHECK(dl_libhost, "NVPW_MetricsContext_GetMetricProperties_Begin");
        NVPW_MetricsContext_GetMetricProperties_End_ptr =
            DLSYM_AND_CHECK(dl_libhost, "NVPW_MetricsContext_GetMetricProperties_End");
    }
    ...
    if (cuda_runtime_version >= 11040) {
        NVPW_CUDA_MetricsEvaluator_CalculateScratchBufferSize_ptr =
            DLSYM_AND_CHECK(dl_libhost, "NVPW_CUDA_MetricsEvaluator_CalculateScratchBufferSize");
        NVPW_CUDA_MetricsEvaluator_Initialize_ptr =
            DLSYM_AND_CHECK(dl_libhost, "NVPW_CUDA_MetricsEvaluator_Initialize");
        NVPW_MetricsEvaluator_ConvertMetricNameToMetricEvalRequest_ptr = DLSYM_AND_CHECK(
            dl_libhost, "NVPW_MetricsEvaluator_ConvertMetricNameToMetricEvalRequest");
        NVPW_MetricsEvaluator_GetMetricRawDependencies_ptr =
            DLSYM_AND_CHECK(dl_libhost, "NVPW_MetricsEvaluator_GetMetricRawDependencies");
        NVPW_MetricsEvaluator_EvaluateToGpuValues_ptr =
            DLSYM_AND_CHECK(dl_libhost, "NVPW_MetricsEvaluator_EvaluateToGpuValues");
        ...
        NVPA_RawMetricsConfig_Create_ptr =
            DLSYM_AND_CHECK(dl_libhost, "NVPA_RawMetricsConfig_Create");
    }
    ...
    NVPW_CounterDataBuilder_GetCounterDataPrefix_ptr =
        DLSYM_AND_CHECK(dl_libhost, "NVPW_CounterDataBuilder_GetCounterDataPrefix");

    NVPW_CounterData_GetNumRanges_ptr =
        DLSYM_AND_CHECK(dl_libhost, "NVPW_CounterData_GetNumRanges");
    NVPW_Profiler_CounterData_GetRangeDescriptions_ptr =
        DLSYM_AND_CHECK(dl_libhost, "NVPW_Profiler_CounterData_GetRangeDescriptions");
    if (cuda_runtime_version < 12060) {
    ...
    cuptiProfilerInitialize_ptr   = DLSYM_AND_CHECK(dl_cupti, "cuptiProfilerInitialize");
    cuptiProfilerDeInitialize_ptr = DLSYM_AND_CHECK(dl_cupti, "cuptiProfilerDeInitialize");
    cuptiDeviceGetChipName_ptr    = DLSYM_AND_CHECK(dl_cupti, "cuptiDeviceGetChipName");
    ...
    cuptiProfilerCounterDataImageCalculateScratchBufferSize_ptr =
        DLSYM_AND_CHECK(dl_cupti, "cuptiProfilerCounterDataImageCalculateScratchBufferSize");
    cuptiProfilerCounterDataImageInitializeScratchBuffer_ptr =
        DLSYM_AND_CHECK(dl_cupti, "cuptiProfilerCounterDataImageInitializeScratchBuffer");
    cuptiProfilerBeginSession_ptr     = DLSYM_AND_CHECK(dl_cupti, "cuptiProfilerBeginSession");
    cuptiProfilerSetConfig_ptr        = DLSYM_AND_CHECK(dl_cupti, "cuptiProfilerSetConfig");
    cuptiProfilerBeginPass_ptr        = DLSYM_AND_CHECK(dl_cupti, "cuptiProfilerBeginPass");
    cuptiProfilerEnableProfiling_ptr  = DLSYM_AND_CHECK(dl_cupti, "cuptiProfilerEnableProfiling");
    cuptiProfilerPushRange_ptr        = DLSYM_AND_CHECK(dl_cupti, "cuptiProfilerPushRange");
    cuptiProfilerPopRange_ptr         = DLSYM_AND_CHECK(dl_cupti, "cuptiProfilerPopRange");
    cuptiProfilerDisableProfiling_ptr = DLSYM_AND_CHECK(dl_cupti, "cuptiProfilerDisableProfiling");
    cuptiProfilerEndPass_ptr          = DLSYM_AND_CHECK(dl_cupti, "cuptiProfilerEndPass");
    cuptiProfilerFlushCounterData_ptr = DLSYM_AND_CHECK(dl_cupti, "cuptiProfilerFlushCounterData");
    cuptiProfilerUnsetConfig_ptr      = DLSYM_AND_CHECK(dl_cupti, "cuptiProfilerUnsetConfig");
    cuptiProfilerEndSession_ptr       = DLSYM_AND_CHECK(dl_cupti, "cuptiProfilerEndSession");
    cuptiGetResultString_ptr          = DLSYM_AND_CHECK(dl_cupti, "cuptiGetResultString");

    if (cuda_runtime_version >= 12060) {
        cuptiProfilerHostInitialize_ptr = DLSYM_AND_CHECK(dl_cupti, "cuptiProfilerHostInitialize");
    ...
    CU_CALL(cuDeviceGetAttribute, &curDeviceId, CU_DEVICE_ATTRIBUTE_COMPUTE_CAPABILITY_MAJOR, dev);
    GPUDEBUG_PRINT(DEBUGLEV_DEVELOP, "Run cuDeviceGetAttribute for minor CC");
    CU_CALL(cuDeviceGetAttribute, &curDeviceId, CU_DEVICE_ATTRIBUTE_COMPUTE_CAPABILITY_MINOR, dev);
    ...
    if (cuda_version >= 11000 && cuda_runtime_version >= 11000) {
        ...
        NVPW_RawMetricsConfig_SetCounterAvailability_ptr =
            DLSYM_AND_CHECK(dl_libhost, "NVPW_RawMetricsConfig_SetCounterAvailability");
    } else {
        cuptiProfilerGetCounterAvailability_ptr = &cuptiProfilerGetCounterAvailability;
        NVPW_RawMetricsConfig_SetCounterAvailability_ptr =
...
static int perfworks_check_nv_context(NvmonDevice_t device, CUcontext currentContext)
{
    int need_pop = 0;
    GPUDEBUG_PRINT(
        DEBUGLEV_DEVELOP, "Current context %ld DevContext %ld", currentContext, device->context);
    if (!device->context) {
        ...
        if (context_of_dev < 0) // && !device->context)
        {
            ...
            GPUDEBUG_PRINT(DEBUGLEV_DEVELOP,
                "Reuse context %ld for device %d",
                device->context,
                device->deviceId);
        } else {
            CUDA_CALL(cudaSetDevice, device->deviceId);
            CUDA_CALL(cudaFree, NULL);
            CU_CALL(cuDevicePrimaryCtxRetain, &device->context, device->cuDevice);
            GPUDEBUG_PRINT(DEBUGLEV_DEVELOP,
                "New context %ld for device %d",
                device->context,
                device->deviceId);
        }
    } else if (device->context != currentContext) {
        GPUDEBUG_PRINT(
            DEBUGLEV_DEVELOP, "Use context %ld for device %d", device->context, device->deviceId);
        CU_CALL(cuCtxPushCurrent, device->context);
        need_pop = 1;
    } else {
        GPUDEBUG_PRINT(
            DEBUGLEV_DEVELOP, "Context %ld fits for device %d", device->context, device->deviceId);
    }
    return need_pop;
}
...
static int cuptiProfiler_init()
{
    if (!cuptiProfiler_initialized) {
        ...
        if (dl_perfworks_libcuda == NULL || dl_perfworks_libcudart == NULL || dl_libhost == NULL ||
            dl_cupti == NULL) {
...
static int nvmon_perfworks_appendEventList(
    NvmonDevice *dev, const char *const *metricNames, size_t numMetrics)
{
...
static int nvmon_perfworks_populateEvents_nvpw(NvmonDevice *dev)
{
    ...
    NVPW_CALL(return -1, NVPW_CUDA_MetricsContext_Create, &metricsContextCreateParams);
    ...
    NVPW_CALL(err - 1;
        goto deinit, NVPW_MetricsContext_GetMetricNames_Begin, &getMetricNameBeginParams);

    err = nvmon_perfworks_appendEventList(
        dev, getMetricNameBeginParams.ppMetricNames, getMetricNameBeginParams.numMetrics);
...
static int nvmon_perfworks_appendSubEvents(NvmonDevice *dev, CUpti_Profiler_Host_Object *hobj,
    CUpti_MetricType type, const char *const *metricSuffixes, size_t numMetrics)
{
    int err                                                        = 0;
    ...
    for (size_t i = 0; i < getBaseMetricsParams.numMetrics; i++) {
        ...
        for (size_t j = 0; j < numMetrics; j++) {
            snprintf(names[j],
                sizeof(names[j]),
                "%s.%s",
                getBaseMetricsParams.ppMetricNames[i],
                metricSuffixes[j]);
            namesList[j] = names[j];
        }
...
static int nvmon_perfworks_populateEvents_cuptiProfilerHost(NvmonDevice *dev)
{
    ...
    int err                          = nvmon_perfworks_appendSubEvents(
        dev, hobj, CUPTI_METRIC_TYPE_COUNTER, suffixesCnt, ARRAY_COUNT(suffixesCnt));
    if (err < 0)
        goto deinit;

    static const char *suffixesRatio[] = { "max_rate", "pct", "ratio" };
    err                                = nvmon_perfworks_appendSubEvents(
        dev, hobj, CUPTI_METRIC_TYPE_RATIO, suffixesRatio, ARRAY_COUNT(suffixesRatio));
    if (err < 0)
        goto deinit;
    ...
    err = nvmon_perfworks_appendSubEvents(
        dev, hobj, CUPTI_METRIC_TYPE_THROUGHPUT, suffixesThru, ARRAY_COUNT(suffixesThru));
    if (err < 0)
        goto deinit;
...
static int nvmon_perfworks_getMetricRequests114(const char *chip, struct bstrList *events,
    uint8_t *availImage, NVPA_RawMetricRequest **requests)
{
    ...
    NVPW_CALL(free(scratch);
        return -1, NVPW_CUDA_MetricsEvaluator_Initialize, &metricEvaluatorInitializeParams);
    ...
    for (int i = 0; i < events->qty; i++) {
        ...
        NVPW_CALL(free(scratch); return -1,
    ...
    NVPA_RawMetricRequest *reqs =
        (NVPA_RawMetricRequest *)malloc(raw_metrics * sizeof(NVPA_RawMetricRequest));
    if (!reqs) {
        free(scratch);
        return -ENOMEM;
    }
    ...
    NVPW_CALL(free(scratch); free(rawDeps); free(reqs);
        return -1, NVPW_MetricsEvaluator_Destroy, &metricEvaluatorDestroyParams);
...
static int nvmon_perfworks_getMetricRequests3(
    NVPA_MetricsContext *context, struct bstrList *events, NVPA_RawMetricRequest **requests)
{
    int isolated      = 1;
    int keepInstances = 1;
    ...
    for (int i = 0; i < events->qty; i++) {
        ...
        for (const char **dep = getMetricPropertiesBeginParams.ppRawMetricDependencies; *dep; ++dep)
            raw_metrics++;
        NVPW_CALL(
            return -1, NVPW_MetricsContext_GetMetricProperties_End, &getMetricPropertiesEndParams);
    }
    ...
    for (int i = 0; i < events->qty; i++) {
        ...
        NVPW_CALL(free(args); return -1,
            NVPW_MetricsContext_GetMetricProperties_Begin,
            &getMetricPropertiesBeginParams);

        for (const char **dep = getMetricPropertiesBeginParams.ppRawMetricDependencies; *dep;
            ++dep) {
...
static int nvmon_perfworks_getMetricRequests(
    NVPA_MetricsContext *context, struct bstrList *events, NVPA_RawMetricRequest **requests)
{
    int isolated            = 1;
    int keepInstances       = 1;
    ...
    for (int i = 0; i < events->qty; i++) {
        ...
        NVPW_CALL(bstrListDestroy(temp); return -EFAULT,
            NVPW_MetricsContext_GetMetricProperties_Begin,
            &getMetricPropertiesBeginParams);
        ...
        NVPW_CALL(bstrListDestroy(temp); return -EFAULT,
            NVPW_MetricsContext_GetMetricProperties_End,
            &getMetricPropertiesEndParams);
    }
    int num_reqs                = 0;
...
static int nvmon_perfworks_createConfigImage(
    const char *chip, struct bstrList *events, uint8_t **configImage, uint8_t *availImage)
{
    int i                                                             = 0;
    int ierr                                                          = 0;
    uint8_t *cimage                                                   = NULL;
    ...
    if (cuda_runtime_version < 11040 && NVPA_RawMetricsConfig_Create_ptr) {
        ...
        GPUDEBUG_PRINT(DEBUGLEV_DEVELOP,
            "Create config image for chip %s with %d metric requests",
            chip,
            num_reqs);
        ...
        NVPW_CALL(ierr = -1; goto nvmon_perfworks_createConfigImage_out,
        ...
        NVPW_CALL(free(reqs);
            return -1, NVPW_CUDA_RawMetricsConfig_Create_V2, &rawMetricsConfigCreateParams);
    ...
    NVPW_CALL(ierr = -1; goto nvmon_perfworks_createConfigImage_out,
        NVPW_RawMetricsConfig_GetNumPasses,
        &getNumPassesParams);
    ...
    NVPW_CALL(free(cimage); ierr = -1; goto nvmon_perfworks_createConfigImage_out,
        NVPW_RawMetricsConfig_GetConfigImage,
        &getConfigImageParams);
...
nvmon_perfworks_createConfigImage_out:
    ...
    NVPW_CALL(return -1, NVPW_RawMetricsConfig_Destroy, &rawMetricsConfigDestroyParams);
    ...
    if (metricsContextCreateParams.pMetricsContext) {
        ...
        NVPW_CALL(return -1, NVPW_MetricsContext_Destroy, &metricsContextDestroyParams);
    }
    ...
    char *chip, struct bstrList *events, uint8_t **cdpImage)
{
    ...
    if (cuda_runtime_version < 12060) {
        ...
        NVPW_CALL(err = -EPERM; goto nvmon_perfworks_createCounterDataPrefixImage_out,
            NVPW_CUDA_MetricsContext_Create,
            &metricsContextCreateParams);
    ...
    NVPW_CALL(err = -EPERM; goto nvmon_perfworks_createCounterDataPrefixImage_out,
        NVPW_CounterDataBuilder_Create,
    ...
    NVPW_CALL(err = -1; goto nvmon_perfworks_createCounterDataPrefixImage_out,
    ...
    NVPW_CALL(free(cdp); err = -1; goto nvmon_perfworks_createCounterDataPrefixImage_out,
        NVPW_CounterDataBuilder_GetCounterDataPrefix,
        &getCounterDataPrefixParams);

nvmon_perfworks_createCounterDataPrefixImage_out:
    GPUDEBUG_PRINT(
        DEBUGLEV_DEVELOP, "nvmon_perfworks_createCounterDataPrefixImage_out enter %d", err);
    // for (i = 0; i < num_reqs; i++)
    // {
    //     free((void*)reqs[i].pMetricName);
    // }
    ...
    NVPW_CALL(err = -1, NVPW_CounterDataBuilder_Destroy, &counterDataBuilderDestroyParams);
    ...
    if (mc) {
        ...
        NVPW_CALL(err = -1, NVPW_MetricsContext_Destroy, &metricsContextDestroyParams);
    }
    /*    for (i = 0; i < num_reqs; i++)*/
    /*    {*/
    /*        free((void*)reqs[i].pMetricName);*/
    ...
    GPUDEBUG_PRINT(
        DEBUGLEV_DEVELOP, "nvmon_perfworks_createCounterDataPrefixImage returns %d", err);
    return err;
}

static int nvmon_perfworks_addEventSet(NvmonDevice_t device, const char *eventString)
{
    ...
    for (int i = 0; i < tmp->qty; i++) {
        ...
        for (int j = 0; j < device->numAllEvents; j++) {
            ...
            if (bstrcmp(parts->entry[0], bname) == BSTR_OK) {
                ...
                GPUDEBUG_PRINT(
                    DEBUGLEV_DEVELOP, "Adding real event %s", device->allevents[j]->real);
            }
        }
    ...
    GPUDEBUG_PRINT(
        DEBUGLEV_DEVELOP, "Increase size of eventSet space on device %d", device->deviceId);
    NvmonEventSet *tmpEventSet =
        realloc(device->nvEventSets, (device->numNvEventSets + 1) * sizeof(NvmonEventSet));
    if (!tmpEventSet) {
    ...
    GPUDEBUG_PRINT(DEBUGLEV_DEVELOP,
        "Filling eventset %d on device %d",
    ...
    if (cuda_version >= 11000 && cuda_runtime_version >= 11000) {
        ...
        CUPTI_CALL(cuptiProfilerGetCounterAvailability, &getCounterAvailabilityParams);
    ...
    int ci_size =
        nvmon_perfworks_createConfigImage(device->chip, eventtokens, &configImage, availImage);
    uint8_t *prefixImage = NULL;
    int pi_size =
        nvmon_perfworks_createCounterDataPrefixImage(device->chip, eventtokens, &prefixImage);
    ...
    if (popContext > 0) {
        GPUDEBUG_PRINT(
            DEBUGLEV_DEVELOP, "Pop Context %ld for device %d", device->context, device->deviceId);
        CU_CALL(cuCtxPopCurrent, &device->context);
    }
    if (curDeviceId != device->deviceId) {
...
{
    GPUDEBUG_PRINT(
        DEBUGLEV_DEVELOP, "counterDataPrefixSize %ld", eventSet->counterDataImagePrefixSize);
    ...
    GPUDEBUG_PRINT(
        DEBUGLEV_DEVELOP, "Resized counterDataImage to %ld", eventSet->counterDataImageSize);
    ...
    GPUDEBUG_PRINT(DEBUGLEV_DEVELOP,
        "Resize counterDataScratchBuffer to %ld",
        scratchBufferSizeParams.counterDataScratchBufferSize);
    tmp = realloc(
        eventSet->counterDataScratchBuffer, scratchBufferSizeParams.counterDataScratchBufferSize);
    if (!tmp)
        return -ENOMEM;
    ...
    GPUDEBUG_PRINT(DEBUGLEV_DEVELOP,
        "Resized counterDataScratchBuffer to %ld",
...
static int nvmon_perfworks_getMetricValue12(char *chip, NvmonEventSet *eventSet, double **values)
{
    ...
    NVPW_MetricEvalRequest *requests =
        calloc(eventSet->numberOfEvents, sizeof(NVPW_MetricEvalRequest));
    if (!requests) {
        free(gpuValues);
        return -errno;
    }
    ...
    NVPW_CALL(err = -EPERM;
        goto cleanup, NVPW_CUDA_MetricsEvaluator_CalculateScratchBufferSize, &scratchBufParams);
    ...
    for (int i = 0; i < eventSet->numberOfEvents; i++) {
        ...
        NVPW_CALL(err = -EPERM; goto cleanup,
            NVPW_MetricsEvaluator_ConvertMetricNameToMetricEvalRequest,
            &convertParams);
    }
    ...
    for (int i = 0; i < eventSet->events->qty; i++) {
        GPUDEBUG_PRINT(
            DEBUGLEV_DEVELOP, "Final Eval %s: %f", bdata(eventSet->events->entry[i]), gpuValues[i]);
    }
    *values = gpuValues;
cleanup:
    free(scratchBuffer);
...
static int nvmon_perfworks_getMetricValue11(char *chip, NvmonEventSet *eventSet, double **values)
{
    assert(eventSet->events->qty == eventSet->numberOfEvents);
    ...
    NVPW_CALL(err = -1; goto nvmon_perfworks_getMetricValue_out,
        NVPW_CUDA_MetricsContext_Create,
        &metricsContextCreateParams);
    ...
    NVPW_CALL(err = -1; goto nvmon_perfworks_getMetricValue_out,
        NVPW_MetricsContext_SetCounterData,
        &setCounterDataParams);
    ...
    NVPW_CALL(err = -1; free(gpuValues); goto nvmon_perfworks_getMetricValue_out,
        NVPW_MetricsContext_EvaluateToGpuValues,
        &evalToGpuParams);
    ...
    for (int j = 0; j < eventSet->events->qty; j++) {
        GPUDEBUG_PRINT(
            DEBUGLEV_DEVELOP, "Final Eval %s: %f", bdata(eventSet->events->entry[j]), gpuValues[j]);
    }
    *values = gpuValues;
...
static int nvmon_perfworks_getMetricValue(char *chip, NvmonEventSet *eventSet, double **values)
{
    if (!chip || !eventSet || !values)
        return -EINVAL;

    if (cuda_runtime_version < 12060)
        return nvmon_perfworks_getMetricValue11(chip, eventSet, values);
    return nvmon_perfworks_getMetricValue12(chip, eventSet, values);
}

static int nvmon_perfworks_setupCounters(NvmonDevice_t device, NvmonEventSet *eventSet)
{
    int curDeviceId = 0;
    CUDA_CALL(cudaGetDevice, &curDeviceId);
    if (curDeviceId != device->deviceId)
...
static int nvmon_perfworks_startCounters(NvmonDevice_t device)
{
    ...
    GPUDEBUG_PRINT(DEBUGLEV_DEVELOP,
        "Start Counters on device %d (Eventset %d)",
        device->deviceId,
        device->activeEventSet);
    ...
    GPUDEBUG_PRINT(
        DEBUGLEV_DEVELOP, "(START)counterDataImageSize %ld", eventSet->counterDataImageSize);
    GPUDEBUG_PRINT(DEBUGLEV_DEVELOP,
        "(START)counterDataScratchBufferSize %ld",
        eventSet->counterDataScratchBufferSize);
...
static int nvmon_perfworks_stopCounters(NvmonDevice_t device)
{
    ...
    GPUDEBUG_PRINT(DEBUGLEV_DEVELOP,
        "Stop Counters on device %d (Eventset %d)",
        device->deviceId,
        device->activeEventSet);
    NvmonEventSet *eventSet                   = &device->nvEventSets[device->activeEventSet];
    ...
    CUpti_Profiler_FlushCounterData_Params flushCounterDataParams = {
        .structSize = CUpti_Profiler_FlushCounterData_Params_size, .ctx = device->context
    };
    ...
    GPUDEBUG_PRINT(DEBUGLEV_DEVELOP,
        "Get results on device %d (Eventset %d)",
        device->deviceId,
        device->activeEventSet);
    ...
    for (int j = 0; j < eventSet->numberOfEvents; j++) {
        ...
        case ENTITY_TYPE_MIN:
            eventSet->results[j].fullValue =
                (res < eventSet->results[j].fullValue ? res : eventSet->results[j].fullValue);
            break;
