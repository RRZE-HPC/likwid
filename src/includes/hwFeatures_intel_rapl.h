...
static _HWFeature intel_rapl_pkg_features[] = {
    ...
    {"pkg_limit_1", "rapl", "Long-term energy limit (PKG domain)", hwFeatures_intel_pkg_energy_limit_1_getter, hwFeatures_intel_pkg_energy_limit_1_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_pkg_energy_limit_test, "mW"},
    {"pkg_limit_1_time", "rapl", "Long-term time window (PKG domain)", hwFeatures_intel_pkg_energy_limit_1_time_getter, hwFeatures_intel_pkg_energy_limit_1_time_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_pkg_energy_limit_test, "ms"},
    {"pkg_limit_1_enable", "rapl", "Status of long-term energy limit (PKG domain)", hwFeatures_intel_pkg_energy_limit_1_enable_getter, hwFeatures_intel_pkg_energy_limit_1_enable_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_pkg_energy_limit_test},
    {"pkg_limit_1_clamp", "rapl", "Clamping status of long-term energy limit (PKG domain)", hwFeatures_intel_pkg_energy_limit_1_clamp_getter, hwFeatures_intel_pkg_energy_limit_1_clamp_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_pkg_energy_limit_test},
    ...
    {"pkg_limit_2_time", "rapl", "Short-term time window (PKG domain)", hwFeatures_intel_pkg_energy_limit_2_time_getter, hwFeatures_intel_pkg_energy_limit_2_time_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_pkg_energy_limit_test, "ms"},
    {"pkg_limit_2_enable", "rapl", "Status of short-term energy limit (PKG domain)", hwFeatures_intel_pkg_energy_limit_2_enable_getter, hwFeatures_intel_pkg_energy_limit_2_enable_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_pkg_energy_limit_test},
    {"pkg_limit_2_clamp", "rapl", "Clamping status of short-term energy limit (PKG domain)", hwFeatures_intel_pkg_energy_limit_2_clamp_getter, hwFeatures_intel_pkg_energy_limit_2_clamp_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_pkg_energy_limit_test},
};
...
static _HWFeature intel_rapl_dram_features[] = {
    ...
    {"dram_limit_time", "rapl", "Long-term time window (DRAM domain)", hwFeatures_intel_dram_energy_limit_1_time_getter, hwFeatures_intel_dram_energy_limit_1_time_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_dram_energy_limit_test, "ms"},
    {"dram_limit_enable", "rapl", "Status of long-term energy limit (DRAM domain)", hwFeatures_intel_dram_energy_limit_1_enable_getter, hwFeatures_intel_dram_energy_limit_1_enable_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_dram_energy_limit_test},
    {"dram_limit_clamp", "rapl", "Clamping status of long-term energy limit (DRAM domain)", hwFeatures_intel_dram_energy_limit_1_clamp_getter, hwFeatures_intel_dram_energy_limit_1_clamp_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_dram_energy_limit_test},
};
...
static _HWFeature intel_rapl_pp0_features[] = {
    ...
    {"pp0_limit_time", "rapl", "Long-term time window (PP0 domain)", hwFeatures_intel_pp0_energy_limit_1_time_getter, hwFeatures_intel_pp0_energy_limit_1_time_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_pp0_energy_limit_test, "ms"},
    {"pp0_limit_enable", "rapl", "Status of long-term energy limit (PP0 domain)", hwFeatures_intel_pp0_energy_limit_1_enable_getter, hwFeatures_intel_pp0_energy_limit_1_enable_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_pp0_energy_limit_test},
    {"pp0_limit_clamp", "rapl", "Clamping status of long-term energy limit (PP0 domain)", hwFeatures_intel_pp0_energy_limit_1_clamp_getter, hwFeatures_intel_pp0_energy_limit_1_clamp_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_pp0_energy_limit_test},
...
static _HWFeature intel_rapl_pp1_features[] = {
    ...
    {"pp1_limit_time", "rapl", "Long-term time window (PP1 domain)", hwFeatures_intel_pp1_energy_limit_1_time_getter, hwFeatures_intel_pp1_energy_limit_1_time_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_pp1_energy_limit_test, "ms"},
    {"pp1_limit_enable", "rapl", "Status of long-term energy limit (PP1 domain)", hwFeatures_intel_pp1_energy_limit_1_enable_getter, hwFeatures_intel_pp1_energy_limit_1_enable_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_pp1_energy_limit_test},
    {"pp1_limit_clamp", "rapl", "Clamping status of long-term energy limit (PP1 domain)", hwFeatures_intel_pp1_energy_limit_1_clamp_getter, hwFeatures_intel_pp1_energy_limit_1_clamp_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_pp1_energy_limit_test},
...
static _HWFeature intel_rapl_psys_features[] = {
    ...
    {"psys_limit_1", "rapl", "Long-term energy limit (PSYS domain)", hwFeatures_intel_psys_energy_limit_1_getter, hwFeatures_intel_psys_energy_limit_1_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_psys_energy_limit_test, "mW"},
    {"psys_limit_1_time", "rapl", "Long-term time window (PSYS domain)", hwFeatures_intel_psys_energy_limit_1_time_getter, hwFeatures_intel_psys_energy_limit_1_time_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_psys_energy_limit_test, "ms"},
    {"psys_limit_1_enable", "rapl", "Status of long-term energy limit (PSYS domain)", hwFeatures_intel_psys_energy_limit_1_enable_getter, hwFeatures_intel_psys_energy_limit_1_enable_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_psys_energy_limit_test},
    {"psys_limit_1_clamp", "rapl", "Clamping status of long-term energy limit (PSYS domain)", hwFeatures_intel_psys_energy_limit_1_clamp_getter, hwFeatures_intel_psys_energy_limit_1_clamp_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_psys_energy_limit_test},
    {"psys_limit_2", "rapl", "Short-term energy limit (PSYS domain)", hwFeatures_intel_psys_energy_limit_2_getter, hwFeatures_intel_psys_energy_limit_2_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_psys_energy_limit_test, "mW"},
    {"psys_limit_2_time", "rapl", "Short-term time window (PSYS domain)", hwFeatures_intel_psys_energy_limit_2_time_getter, hwFeatures_intel_psys_energy_limit_2_time_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_psys_energy_limit_test, "ms"},
    {"psys_limit_2_enable", "rapl", "Status of short-term energy limit (PSYS domain)", hwFeatures_intel_psys_energy_limit_2_enable_getter, hwFeatures_intel_psys_energy_limit_2_enable_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_psys_energy_limit_test},
    {"psys_limit_2_clamp", "rapl", "Clamping status of short-term energy limit (PSYS domain)", hwFeatures_intel_psys_energy_limit_2_clamp_getter, hwFeatures_intel_psys_energy_limit_2_clamp_setter, DEVICE_TYPE_SOCKET, hwFeatures_intel_psys_energy_limit_test},
};
