...
#define TESTTYPE(eventset, type) \
    (((type) >= 0 && (type) <= 63 ? eventset->regTypeMask1 & (1ULL << (type)) : ((type) >= 64 && (type) <= 127 ? eventset->regTypeMask2 & (1ULL << ((type) - 64)) : ((type) >= 128 && (type) <= 191 ? eventset->regTypeMask3 & (1ULL << ((type) - 128)) : ((type) >= 192 && (type) <= 255 ? eventset->regTypeMask4 & (1ULL << ((type) - 192)) : ((type) >= 256 && (type) <= 319 ? eventset->regTypeMask5 & (1ULL << ((type) - 256)) : ((type) >= 320 && (type) <= 383 ? eventset->regTypeMask6 & (1ULL << ((type) - 320)) : ((type) >= 384 && (type) <= 447 ? eventset->regTypeMask7 & (1ULL << ((type) - 384)) : ((type) >= 448 && (type) <= 511 ? eventset->regTypeMask8 & (1ULL << ((type) - 448)) : ((type) >= 512 && (type) <= 575 ? eventset->regTypeMask9 & (1ULL << ((type) - 512)) : 0x0ULL))))))))))
