...
static char *RegisterTypeNames[MAX_UNITS] = { [PMC] = "Core-local general purpose counters",
            ...
            : ((type) >= 64 && (type) <= 127                                                                           \
                      ...
                      : ((type) >= 128 && (type) <= 191                                                                \
                                ...
                                : ((type) >= 192 && (type) <= 255                                                      \
                                          ...
                                          : ((type) >= 256 && (type) <= 319                                            \
                                                    ? eventset->regTypeMask5 &                                         \
                                                          (1ULL << ((type) - 256))                                     \
                                                    : ((type) >= 320 && (type) <= 383                                  \
                                                              ? eventset->regTypeMask6 &                               \
                                                                    (1ULL << ((type) - 320))                           \
                                                              : ((type) >= 384 && (type) <= 447                        \
                                                                        ? eventset->regTypeMask7 &                     \
                                                                              (1ULL << ((type) -                       \
                                                                                        384))                          \
                                                                        : ((type) >= 448 &&                            \
                                                                                      (type) <=                        \
                                                                                          511                          \
                                                                                  ? eventset->regTypeMask8 &           \
                                                                                        (1ULL                          \
                                                                                            << ((type) -               \
                                                                                                   448))               \
                                                                                  : ((type) >= 512 &&                  \
...
#define MEASURE_UNCORE(eventset)                                                                   \
    (eventset->regTypeMask1 &                                                                      \
            ~(REG_TYPE_MASK(PMC) | REG_TYPE_MASK(FIXED) | REG_TYPE_MASK(THERMAL) |                 \
                REG_TYPE_MASK(VOLTAGE) | REG_TYPE_MASK(PERF) | REG_TYPE_MASK(POWER) |              \
                REG_TYPE_MASK(METRICS)) ||                                                         \
        eventset->regTypeMask2 || eventset->regTypeMask3 || eventset->regTypeMask4 ||              \
        eventset->regTypeMask5 || eventset->regTypeMask6 || eventset->regTypeMask7 ||              \
        eventset->regTypeMask8 || eventset->regTypeMask9)
