...
#define NUM_COUNTERS_IVYBRIDGE 33

#define IVB_VALID_OPTIONS_PMC EVENT_OPTION_EDGE_MASK | EVENT_OPTION_COUNT_KERNEL_MASK | EVENT_OPTION_INVERT_MASK | EVENT_OPTION_ANYTHREAD_MASK | EVENT_OPTION_THRESHOLD_MASK
...
static RegisterMap ivybridge_counter_map[NUM_COUNTERS_IVYBRIDGE] = {
    ...
    { "CBOX0C0",   PMC17, CBOX0,    MSR_UNC_CBO_0_PERFEVTSEL0, MSR_UNC_CBO_0_CTR0,     0, 0,                     IVB_VALID_OPTIONS_CBOX  },
    { "CBOX0C1",   PMC18, CBOX0,    MSR_UNC_CBO_0_PERFEVTSEL1, MSR_UNC_CBO_0_CTR1,     0, 0,                     IVB_VALID_OPTIONS_CBOX  },
    { "CBOX1C0",   PMC19, CBOX1,    MSR_UNC_CBO_1_PERFEVTSEL0, MSR_UNC_CBO_1_CTR0,     0, 0,                     IVB_VALID_OPTIONS_CBOX  },
    { "CBOX1C1",   PMC20, CBOX1,    MSR_UNC_CBO_1_PERFEVTSEL1, MSR_UNC_CBO_1_CTR1,     0, 0,                     IVB_VALID_OPTIONS_CBOX  },
    { "CBOX2C0",   PMC21, CBOX2,    MSR_UNC_CBO_2_PERFEVTSEL0, MSR_UNC_CBO_2_CTR0,     0, 0,                     IVB_VALID_OPTIONS_CBOX  },
    { "CBOX2C1",   PMC22, CBOX2,    MSR_UNC_CBO_2_PERFEVTSEL1, MSR_UNC_CBO_2_CTR1,     0, 0,                     IVB_VALID_OPTIONS_CBOX  },
    { "CBOX3C0",   PMC23, CBOX3,    MSR_UNC_CBO_3_PERFEVTSEL0, MSR_UNC_CBO_3_CTR0,     0, 0,                     IVB_VALID_OPTIONS_CBOX  },
    { "CBOX3C1",   PMC24, CBOX3,    MSR_UNC_CBO_3_PERFEVTSEL1, MSR_UNC_CBO_3_CTR1,     0, 0,                     IVB_VALID_OPTIONS_CBOX  },
    { "UBOX0",     PMC25, UBOX,     MSR_UNC_ARB_PERFEVTSEL0,   MSR_UNC_ARB_CTR0,       0, 0,                     IVB_VALID_OPTIONS_UBOX  },
    { "UBOX1",     PMC26, UBOX,     MSR_UNC_ARB_PERFEVTSEL1,   MSR_UNC_ARB_CTR1,       0, 0,                     IVB_VALID_OPTIONS_UBOX  },
