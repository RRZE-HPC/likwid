...
#define ICX_VALID_OPTIONS_EUBOX EVENT_OPTION_EDGE_MASK|EVENT_OPTION_INVERT_MASK|\
            EVENT_OPTION_THRESHOLD_MASK|EVENT_OPTION_MASK0_MASK|EVENT_OPTION_MASK1_MASK
