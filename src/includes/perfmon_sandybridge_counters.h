...
static RegisterMap sandybridge_counter_map[NUM_COUNTERS_SANDYBRIDGE] = {
    ...
    {"MBOX0C0",PMC47, MBOX0, PCI_UNC_MC_PMON_CTL_0, PCI_UNC_MC_PMON_CTR_0_A, PCI_UNC_MC_PMON_CTR_0_B, PCI_IMC_DEVICE_CH_0, EVENT_OPTION_NONE_MASK},
    {"MBOX0C1",PMC48, MBOX0, PCI_UNC_MC_PMON_CTL_1, PCI_UNC_MC_PMON_CTR_1_A, PCI_UNC_MC_PMON_CTR_1_B, PCI_IMC_DEVICE_CH_0, EVENT_OPTION_NONE_MASK},
    {"MBOX0C2",PMC49, MBOX0, PCI_UNC_MC_PMON_CTL_2, PCI_UNC_MC_PMON_CTR_2_A, PCI_UNC_MC_PMON_CTR_2_B, PCI_IMC_DEVICE_CH_0, EVENT_OPTION_NONE_MASK},
    {"MBOX0C3",PMC50, MBOX0, PCI_UNC_MC_PMON_CTL_3, PCI_UNC_MC_PMON_CTR_3_A, PCI_UNC_MC_PMON_CTR_3_B, PCI_IMC_DEVICE_CH_0, EVENT_OPTION_NONE_MASK},
    ...
    {"MBOX1C0",PMC52, MBOX1, PCI_UNC_MC_PMON_CTL_0, PCI_UNC_MC_PMON_CTR_0_A, PCI_UNC_MC_PMON_CTR_0_B, PCI_IMC_DEVICE_CH_1, EVENT_OPTION_NONE_MASK},
    {"MBOX1C1",PMC53, MBOX1, PCI_UNC_MC_PMON_CTL_1, PCI_UNC_MC_PMON_CTR_1_A, PCI_UNC_MC_PMON_CTR_1_B, PCI_IMC_DEVICE_CH_1, EVENT_OPTION_NONE_MASK},
    {"MBOX1C2",PMC54, MBOX1, PCI_UNC_MC_PMON_CTL_2, PCI_UNC_MC_PMON_CTR_2_A, PCI_UNC_MC_PMON_CTR_2_B, PCI_IMC_DEVICE_CH_1, EVENT_OPTION_NONE_MASK},
    {"MBOX1C3",PMC55, MBOX1, PCI_UNC_MC_PMON_CTL_3, PCI_UNC_MC_PMON_CTR_3_A, PCI_UNC_MC_PMON_CTR_3_B, PCI_IMC_DEVICE_CH_1, EVENT_OPTION_NONE_MASK},
    ...
    {"MBOX2C0",PMC57, MBOX2, PCI_UNC_MC_PMON_CTL_0, PCI_UNC_MC_PMON_CTR_0_A, PCI_UNC_MC_PMON_CTR_0_B, PCI_IMC_DEVICE_CH_2, EVENT_OPTION_NONE_MASK},
    {"MBOX2C1",PMC58, MBOX2, PCI_UNC_MC_PMON_CTL_1, PCI_UNC_MC_PMON_CTR_1_A, PCI_UNC_MC_PMON_CTR_1_B, PCI_IMC_DEVICE_CH_2, EVENT_OPTION_NONE_MASK},
    {"MBOX2C2",PMC59, MBOX2, PCI_UNC_MC_PMON_CTL_2, PCI_UNC_MC_PMON_CTR_2_A, PCI_UNC_MC_PMON_CTR_2_B, PCI_IMC_DEVICE_CH_2, EVENT_OPTION_NONE_MASK},
    {"MBOX2C3",PMC60, MBOX2, PCI_UNC_MC_PMON_CTL_3, PCI_UNC_MC_PMON_CTR_3_A, PCI_UNC_MC_PMON_CTR_3_B, PCI_IMC_DEVICE_CH_2, EVENT_OPTION_NONE_MASK},
    ...
    {"MBOX0C0",PMC62, MBOX3, PCI_UNC_MC_PMON_CTL_0, PCI_UNC_MC_PMON_CTR_0_A, PCI_UNC_MC_PMON_CTR_0_B, PCI_IMC_DEVICE_CH_3, EVENT_OPTION_NONE_MASK},
    {"MBOX1C1",PMC63, MBOX3, PCI_UNC_MC_PMON_CTL_1, PCI_UNC_MC_PMON_CTR_1_A, PCI_UNC_MC_PMON_CTR_1_B, PCI_IMC_DEVICE_CH_3, EVENT_OPTION_NONE_MASK},
    {"MBOX2C2",PMC64, MBOX3, PCI_UNC_MC_PMON_CTL_2, PCI_UNC_MC_PMON_CTR_2_A, PCI_UNC_MC_PMON_CTR_2_B, PCI_IMC_DEVICE_CH_3, EVENT_OPTION_NONE_MASK},
    {"MBOX3C3",PMC65, MBOX3, PCI_UNC_MC_PMON_CTL_3, PCI_UNC_MC_PMON_CTR_3_A, PCI_UNC_MC_PMON_CTR_3_B, PCI_IMC_DEVICE_CH_3, EVENT_OPTION_NONE_MASK},
    ...
    {"WBOXFIX0", PMC80, WBOXFIX0, 0, MSR_UNC_PCU_PMON_BOX_CTL1, 0, 0, EVENT_OPTION_NONE_MASK},
    {"WBOXFIX1", PMC81, WBOXFIX1, 0, MSR_UNC_PCU_PMON_BOX_CTL2, 0, 0, EVENT_OPTION_NONE_MASK}
};
