...
uint64_t gnr_uncore_fixed_setup(
    int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data)
{
    (void)data;
...
static PerfmonFuncs GnrUnitFuncs[NUM_UNITS] = {
    ...
    [MBOX0... MBOX15]       = { gnr_uncore_setup,
                 gnr_uncore_start,                           gnr_uncore_stop,
                 gnr_uncore_read,                                                                     PERFMON_LOCK_SOCKET },
    [MBOX0FIX... MBOX15FIX] = { gnr_uncore_fixed_setup,
                 gnr_uncore_fixed_start,                     gnr_uncore_fixed_stop,
                 gnr_uncore_fixed_read,                                                               PERFMON_LOCK_SOCKET },
    [UBOX]                  = { gnr_uncore_setup,
                 gnr_uncore_start,                           gnr_uncore_stop,
                 gnr_uncore_read,                                                                     PERFMON_LOCK_SOCKET },
    [MDF0... MDF49]         = { gnr_uncore_setup,
                 gnr_uncore_start,                           gnr_uncore_stop,
                 gnr_uncore_read,                                                                     PERFMON_LOCK_SOCKET },
    [QBOX0... QBOX3]        = { gnr_uncore_setup,
                 gnr_uncore_start,                           gnr_uncore_stop,
                 gnr_uncore_read,                                                                     PERFMON_LOCK_SOCKET },
    [WBOX0... WBOX3]        = { gnr_uncore_setup,
                 gnr_uncore_start,                           gnr_uncore_stop,
                 gnr_uncore_read,                                                                     PERFMON_LOCK_SOCKET },
    [CBOX0... CBOX127]      = { gnr_uncore_setup,
                 gnr_uncore_start,                           gnr_uncore_stop,
                 gnr_uncore_read,                                                                     PERFMON_LOCK_SOCKET },
    [BBOX0... BBOX31]       = { gnr_uncore_setup,
                 gnr_uncore_start,                           gnr_uncore_stop,
                 gnr_uncore_read,                                                                     PERFMON_LOCK_SOCKET },
    [PBOX0... PBOX31]       = { gnr_uncore_setup,
                 gnr_uncore_start,                           gnr_uncore_stop,
                 gnr_uncore_read,                                                                     PERFMON_LOCK_SOCKET },
    [RBOX0... RBOX3]        = { gnr_uncore_setup,
                 gnr_uncore_start,                           gnr_uncore_stop,
                 gnr_uncore_read,                                                                     PERFMON_LOCK_SOCKET },
    [IRP0... IRP15]         = { gnr_uncore_setup,
                 gnr_uncore_start,                           gnr_uncore_stop,
                 gnr_uncore_read,                                                                     PERFMON_LOCK_SOCKET },
    [IBOX0... IBOX15]       = { gnr_uncore_setup,
                 gnr_uncore_start,                           gnr_uncore_stop,
                 gnr_uncore_read,                                                                     PERFMON_LOCK_SOCKET },
};
