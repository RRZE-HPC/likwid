...
uint64_t gnr_fixed_setup(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_fixed_setup(thread_id, index, event, data); }

uint64_t gnr_fixed_start(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_fixed_start(thread_id, index, event, data); }

uint64_t gnr_pmc_setup(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_pmc_setup(thread_id, index, event, data); }

uint64_t gnr_uncore_setup(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_setup_uncore(thread_id, index, event); }

uint64_t gnr_uncore_fixed_setup(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_setup_uncore_fixed(thread_id, index, event); }

uint64_t gnr_pmc_start(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_pmc_start(thread_id, index, event, data); }

uint64_t gnr_power_start(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_power_start(thread_id, index, event, data); }

uint64_t gnr_metrics_start(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_metrics_start(thread_id, index, event, data); }

uint64_t gnr_uncore_start(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_start_uncore(thread_id, index, event, data); }

uint64_t gnr_uncore_fixed_start(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_start_uncore_fixed(thread_id, index, event, data); }

uint64_t gnr_fixed_stop(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_fixed_stop(thread_id, index, event, data); }

uint64_t gnr_pmc_stop(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_pmc_stop(thread_id, index, event, data); }

uint64_t gnr_power_stop(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_power_stop(thread_id, index, event, data); }

uint64_t gnr_thermal_stop(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_thermal_stop(thread_id, index, event, data); }

uint64_t gnr_voltage_stop(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_voltage_stop(thread_id, index, event, data); }

uint64_t gnr_metrics_stop(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_metrics_stop(thread_id, index, event, data); }

uint64_t gnr_uncore_stop(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_stop_uncore(thread_id, index, event, data); }

uint64_t gnr_uncore_fixed_stop(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_stop_uncore_fixed(thread_id, index, event, data); }

uint64_t gnr_fixed_read(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_fixed_read(thread_id, index, event, data); }

uint64_t gnr_pmc_read(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_pmc_read(thread_id, index, event, data); }

uint64_t gnr_power_read(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_power_read(thread_id, index, event, data); }

uint64_t gnr_thermal_read(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_thermal_read(thread_id, index, event, data); }

uint64_t gnr_voltage_read(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_voltage_read(thread_id, index, event, data); }

uint64_t gnr_metrics_read(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_metrics_read(thread_id, index, event, data); }

uint64_t gnr_uncore_read(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_read_uncore(thread_id, index, event, data); }

uint64_t gnr_uncore_fixed_read(int thread_id, RegisterIndex index, PerfmonEvent *event, PerfmonCounter *data) { return spr_read_uncore_fixed(thread_id, index, event, data); }
...
int perfmon_setupCounterThread_graniterapids(int thread_id, PerfmonEventSet *eventSet)
{
    int err              = 0;
    int haveLock         = 0;
