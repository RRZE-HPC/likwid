...
#define SKX_VALID_OPTIONS_PMC EVENT_OPTION_EDGE_MASK | EVENT_OPTION_COUNT_KERNEL_MASK | EVENT_OPTION_INVERT_MASK | EVENT_OPTION_ANYTHREAD_MASK | EVENT_OPTION_IN_TRANS_MASK | EVENT_OPTION_THRESHOLD_MASK
#define SKX_VALID_OPTIONS_CBOX EVENT_OPTION_EDGE_MASK | EVENT_OPTION_INVERT_MASK | EVENT_OPTION_THRESHOLD_MASK | EVENT_OPTION_TID_MASK | EVENT_OPTION_MATCH0_MASK | EVENT_OPTION_MATCH1_MASK | EVENT_OPTION_OPCODE_MASK | EVENT_OPTION_STATE_MASK
