...
static char* knl_translate_types[NUM_UNITS] = {
    ...
    [EUBOX0FIX] = "/sys/bus/event_source/devices/uncore_edc_uclk_0",
    [EUBOX1FIX] = "/sys/bus/event_source/devices/uncore_edc_uclk_1",
    [EUBOX2FIX] = "/sys/bus/event_source/devices/uncore_edc_uclk_2",
    [EUBOX3FIX] = "/sys/bus/event_source/devices/uncore_edc_uclk_3",
    [EUBOX4FIX] = "/sys/bus/event_source/devices/uncore_edc_uclk_4",
    [EUBOX5FIX] = "/sys/bus/event_source/devices/uncore_edc_uclk_5",
    [EUBOX6FIX] = "/sys/bus/event_source/devices/uncore_edc_uclk_6",
    [EUBOX7FIX] = "/sys/bus/event_source/devices/uncore_edc_uclk_7",
    [EDBOX0FIX] = "/sys/bus/event_source/devices/uncore_edc_eclk_0",
    [EDBOX1FIX] = "/sys/bus/event_source/devices/uncore_edc_eclk_1",
    [EDBOX2FIX] = "/sys/bus/event_source/devices/uncore_edc_eclk_2",
    [EDBOX3FIX] = "/sys/bus/event_source/devices/uncore_edc_eclk_3",
    [EDBOX4FIX] = "/sys/bus/event_source/devices/uncore_edc_eclk_4",
    [EDBOX5FIX] = "/sys/bus/event_source/devices/uncore_edc_eclk_5",
    [EDBOX6FIX] = "/sys/bus/event_source/devices/uncore_edc_eclk_6",
    [EDBOX7FIX] = "/sys/bus/event_source/devices/uncore_edc_eclk_7",
