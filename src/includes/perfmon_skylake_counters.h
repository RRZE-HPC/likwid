 ...
 * =======================================================================================
 */
#ifndef PERFMON_SKYLAKE_COUNTERS_H
#define PERFMON_SKYLAKE_COUNTERS_H
...
static RegisterMap skylake_counter_map[NUM_COUNTERS_SKYLAKE] = {
    ...
    { "MBOX0C0",   PMC29, MBOX0,    0x0,                     0x0,                        0, PCI_IMC_DEVICE_0_CH_0, EVENT_OPTION_NONE_MASK                                   },
    { "MBOX0C1",   PMC30, MBOX0,    0x0,                     0x1,                        0, PCI_IMC_DEVICE_0_CH_0, EVENT_OPTION_NONE_MASK                                   },
    { "MBOX0C2",   PMC31, MBOX0,    0x0,                     0x2,                        0, PCI_IMC_DEVICE_0_CH_0, EVENT_OPTION_NONE_MASK                                   },
    { "MBOX0TMP0", PMC32, MBOX0TMP, 0x0,                     0x3,                        0, PCI_IMC_DEVICE_0_CH_0, EVENT_OPTION_NONE_MASK                                   },
    { "MBOX0TMP1", PMC33, MBOX0TMP, 0x0,                     0x4,                        0, PCI_IMC_DEVICE_0_CH_0, EVENT_OPTION_NONE_MASK                                   },
    /* PERF */
...
#endif //PERFMON_SKYLAKE_COUNTERS_H
