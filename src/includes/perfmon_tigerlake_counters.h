...
#define NUM_COUNTERS_TIGERLAKE 19
#define NUM_COUNTERS_CORE_TIGERLAKE 14
...
static RegisterMap tigerlake_counter_map[NUM_COUNTERS_TIGERLAKE] = {
    ...
    {"FIXC4", PMC4, FIXED, MSR_PERF_FIXED_CTR_CTRL, MSR_PERF_METRICS, 0, 0, EVENT_OPTION_NONE_MASK}, // if MSR_PERF_CAPABILITIES[15] == 1
    ...
    /* Temperature Sensor*/
    {"TMP0", PMC13, THERMAL, 0, IA32_THERM_STATUS, 0, 0, EVENT_OPTION_NONE_MASK},
    /* RAPL counters */
    {"PWR0", PMC14, POWER, 0, MSR_PKG_ENERGY_STATUS, 0, 0, EVENT_OPTION_NONE_MASK},
    {"PWR1", PMC15, POWER, 0, MSR_PP0_ENERGY_STATUS, 0, 0, EVENT_OPTION_NONE_MASK},
    {"PWR2", PMC16, POWER, 0, MSR_PP1_ENERGY_STATUS,  0, 0, EVENT_OPTION_NONE_MASK},
    {"PWR3", PMC17, POWER, 0, MSR_DRAM_ENERGY_STATUS,  0, 0, EVENT_OPTION_NONE_MASK},
    {"PWR4", PMC18, POWER, 0, MSR_PLATFORM_ENERGY_STATUS,  0, 0, EVENT_OPTION_NONE_MASK},
};
