...
int perfmon_setupCounterThread_sapphirerapids(int thread_id, PerfmonEventSet *eventSet)
{
    int err              = 0;
    int haveLock         = 0;
