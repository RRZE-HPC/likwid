...
void perfmon_init_k10(int cpu_id)
{
...
void perfmon_startCountersThread_k10(int thread_id, PerfmonEventSet* eventSet)
{
    uint64_t flags;
    int cpu_id = groupSet->threads[thread_id].processorId;
...
void perfmon_stopCountersThread_k10(int thread_id, PerfmonEventSet* eventSet)
{
    uint64_t flags;
    uint64_t tmp;
    int cpu_id = groupSet->threads[thread_id].processorId;
...
void perfmon_readCountersThread_k10(int thread_id, PerfmonEventSet* eventSet)
{
	uint64_t tmp;
    int cpu_id = groupSet->threads[thread_id].processorId;
