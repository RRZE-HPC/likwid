...
static const char *LOG_LEVEL_PREFIX_NORMAL[DEBUG_LEV_COUNT] = {
    "ERROR",
    "WARN",
    "INFO",
    "DEBUG",
...
static const char *LOG_LEVEL_PREFIX_COLOR[DEBUG_LEV_COUNT] = {
...
static const char *LOG_CAT_PREFIX_NORMAL[DEBUG_CAT_COUNT] = {
    "CORE",
    "NVMON",
    "ROCMON",
};

static const char *LOG_CAT_PREFIX_COLOR[DEBUG_CAT_COUNT] = {
