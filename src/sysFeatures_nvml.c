...
static _SysFeature nvidia_gpu_features[] = {
    { "device_count",
     "nvml", "Number of GPUs on node. Not all GPUs may be accessible.",
     nvidia_gpu_device_count_getter, NULL,
     DEVICE_TYPE_NODE },
    { "devices_available",
     "nvml", "Available GPUs (PCI addresses)",
     nvidia_gpu_devices_available_getter, NULL,
     DEVICE_TYPE_NODE },
    { "gfx_clock_cur",
     "nvml", "Current clock speed (graphics domain)",
     nvidia_gpu_gfx_clock_cur_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "MHz" },
    { "gfx_clock_app_target",
     "nvml", "Application target clock speed (graphics domain)",
     nvidia_gpu_gfx_clock_app_target_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "MHz" },
    { "gfx_clock_app_default",
     "nvml", "Application default clock speed (graphics domain)",
     nvidia_gpu_gfx_clock_app_default_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "MHz" },
    { "gfx_clock_boost_max",
     "nvml", "Application default clock speed (graphics domain)",
     nvidia_gpu_gfx_clock_boost_max_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "MHz" },
    { "sm_clock_cur",
     "nvml", "Current clock speed (SM domain)",
     nvidia_gpu_sm_clock_cur_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "MHz" },
    { "sm_clock_app_target",
     "nvml", "Application target clock speed (SM domain)",
     nvidia_gpu_sm_clock_app_target_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "MHz" },
    { "sm_clock_app_default",
     "nvml", "Application default clock speed (SM domain)",
     nvidia_gpu_sm_clock_app_default_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "MHz" },
    { "sm_clock_boost_max",
     "nvml", "Application default clock speed (SM domain)",
     nvidia_gpu_sm_clock_boost_max_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "MHz" },
    { "dram_clock_cur",
     "nvml", "Current clock speed (memory domain)",
     nvidia_gpu_dram_clock_cur_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "MHz" },
    { "dram_clock_app_target",
     "nvml", "Application target clock speed (memory domain)",
     nvidia_gpu_dram_clock_app_target_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "MHz" },
    { "dram_clock_app_default",
     "nvml", "Application default clock speed (memory domain)",
     nvidia_gpu_dram_clock_app_default_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "MHz" },
    { "dram_clock_boost_max",
     "nvml", "Application default clock speed (memory domain)",
     nvidia_gpu_dram_clock_boost_max_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "MHz" },
    { "video_clock_cur",
     "nvml", "Current clock speed (video encoder/decoder domain)",
     nvidia_gpu_video_clock_cur_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "MHz" },
    { "video_clock_app_target",
     "nvml", "Application target clock speed (video encoder/decoder domain)",
     nvidia_gpu_video_clock_app_target_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "MHz" },
    { "video_clock_app_default",
     "nvml", "Application default clock speed (video encoder/decoder domain)",
     nvidia_gpu_video_clock_app_default_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "MHz" },
    { "video_clock_boost_max",
     "nvml", "Application default clock speed (video encoder/decoder domain)",
     nvidia_gpu_video_clock_boost_max_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "MHz" },
    { "pci_bar1_free",
     "nvml", "Unallocated BAR1 memory",
     nvidia_gpu_bar1_free_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "Byte" },
    { "pci_bar1_used",
     "nvml", "Allocated BAR1 memory",
     nvidia_gpu_bar1_used_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "Byte" },
    { "pci_bar1_total",
     "nvml", "Total BAR1 memory",
     nvidia_gpu_bar1_total_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "Byte" },
    { "bus_type",
     "nvml", "GPU Bus Type",
     nvidia_gpu_bus_type_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "pcie_link_gen_cur",
     "nvml", "Current PCIe link generation",
     nvidia_gpu_pcie_gen_cur_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "pcie_link_gen_gpu_max",
     "nvml", "Maximum PCIe link generation (GPU only)",
     nvidia_gpu_pcie_gen_gpu_max_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "pcie_link_gen_sys_max",
     "nvml", "Maximum PCIe link generation (GPU/system combination)",
     nvidia_gpu_pcie_gen_sys_max_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "pcie_link_width_cur",
     "nvml", "Current PCIe link width (GPU only)",
     nvidia_gpu_pcie_width_cur_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "pcie_link_width_sys_max",
     "nvml", "Maximum PCIe link width (CPU/system combination)",
     nvidia_gpu_pcie_width_sys_max_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "pcie_link_rate_cur",
     "nvml", "Current PCIe link speed",
     nvidia_gpu_pcie_speed_cur_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "MB/s" },
    { "pcie_link_rate_max",
     "nvml", "Maximum PCIe link speed",
     nvidia_gpu_pcie_speed_max_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "MB/s" },
    { "pcie_replay_counter",
     "nvml", "PCIe replay counter",
     nvidia_gpu_pcie_replay_counter_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "pcie_throughput_tx",
     "nvml", "Current PCIe throughput (TX)",
     nvidia_gpu_pcie_throughput_tx_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "KB/s" },
    { "pcie_throughput_rx",
     "nvml", "Current PCIe throughput (RX)",
     nvidia_gpu_pcie_throughput_rx_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "KB/s" },
    { "decoder_usage",
     "nvml", "Current decoder usage",
     nvidia_gpu_decoder_util_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "ecc_enabled_default",
     "nvml", "DRAM ECC enable default",
     nvidia_gpu_ecc_default_enabled_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "ecc_enabled_cur",
     "nvml", "DRAM ECC currently enabled",
     nvidia_gpu_ecc_enabled_cur_getter, nvidia_gpu_ecc_enabled_setter,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "ecc_enabled_pend",
     "nvml", "DRAM ECC enable pending (after reboot)",
     nvidia_gpu_ecc_enabled_pend_getter, nvidia_gpu_ecc_enabled_setter,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "ecc_dram_volatile_corr_err_count",
     "nvml", "DRAM ECC corrected errors (GPU lifetime aggregate)",
     nvidia_gpu_ecc_error_dram_vol_corr_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "ecc_dram_volatile_uncorr_err_count",
     "nvml", "DRAM ECC corrected errors (since reboot)",
     nvidia_gpu_ecc_error_dram_vol_uncorr_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "ecc_dram_aggregate_corr_err_count",
     "nvml", "DRAM ECC corrected errors (GPU lifetime aggregate)",
     nvidia_gpu_ecc_error_dram_agg_corr_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "ecc_dram_aggregate_uncorr_err_count",
     "nvml", "DRAM ECC corrected errors (since reboot)",
     nvidia_gpu_ecc_error_dram_agg_uncorr_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "ecc_l1_volatile_corr_err_count",
     "nvml", "L1 ECC corrected errors (GPU lifetime aggregate)",
     nvidia_gpu_ecc_error_l1_vol_corr_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "ecc_l1_volatile_uncorr_err_count",
     "nvml", "L1 ECC corrected errors (since reboot)",
     nvidia_gpu_ecc_error_l1_vol_uncorr_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "ecc_l1_aggregate_corr_err_count",
     "nvml", "L1 ECC corrected errors (GPU lifetime aggregate)",
     nvidia_gpu_ecc_error_l1_agg_corr_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "ecc_l1_aggregate_uncorr_err_count",
     "nvml", "L1 ECC corrected errors (since reboot)",
     nvidia_gpu_ecc_error_l1_agg_uncorr_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "ecc_l2_volatile_corr_err_count",
     "nvml", "L2 ECC corrected errors (GPU lifetime aggregate)",
     nvidia_gpu_ecc_error_l2_vol_corr_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "ecc_l2_volatile_uncorr_err_count",
     "nvml", "L2 ECC corrected errors (since reboot)",
     nvidia_gpu_ecc_error_l2_vol_uncorr_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "ecc_l2_aggregate_corr_err_count",
     "nvml", "L2 ECC corrected errors (GPU lifetime aggregate)",
     nvidia_gpu_ecc_error_l2_agg_corr_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "ecc_l2_aggregate_uncorr_err_count",
     "nvml", "L2 ECC corrected errors (since reboot)",
     nvidia_gpu_ecc_error_l2_agg_uncorr_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "ecc_reg_volatile_corr_err_count",
     "nvml", "REG ECC corrected errors (GPU lifetime aggregate)",
     nvidia_gpu_ecc_error_reg_vol_corr_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "ecc_reg_volatile_uncorr_err_count",
     "nvml", "REG ECC corrected errors (since reboot)",
     nvidia_gpu_ecc_error_reg_vol_uncorr_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "ecc_reg_aggregate_corr_err_count",
     "nvml", "REG ECC corrected errors (GPU lifetime aggregate)",
     nvidia_gpu_ecc_error_reg_agg_corr_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "ecc_reg_aggregate_uncorr_err_count",
     "nvml", "REG ECC corrected errors (since reboot)",
     nvidia_gpu_ecc_error_reg_agg_uncorr_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "fan_speed",
     "nvml", "Fan speed",
     nvidia_gpu_fan_speed_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "%" },
    { "pstate_cur",
     "nvml", "Current performance state",
     nvidia_gpu_pstate_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "power_limit_default",
     "nvml", "Default power limit",
     nvidia_gpu_power_limit_default_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "W" },
    { "power_limit_cur",
     "nvml", "Current power limit",
     nvidia_gpu_power_limit_cur_getter, nvidia_gpu_power_limit_cur_setter,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "W" },
    { "power_limit_min",
     "nvml", "Minimum power limit",
     nvidia_gpu_power_limit_min_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "W" },
    { "power_limit_max",
     "nvml", "Maximum power limit",
     nvidia_gpu_power_limit_max_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "W" },
    { "power_limit_enf",
     "nvml", "Enforced (resulting) power limit",
     nvidia_gpu_power_limit_enf_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "W" },
    { "power_usage",
     "nvml", "Current power usage",
     nvidia_gpu_power_cur_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "W" },
    { "encoder_cap_h264",
     "nvml", "Video encoder H264 capacity",
     nvidia_gpu_encoder_capacity_h264_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "%" },
    { "encoder_cap_hevc",
     "nvml", "Video encoder HEVC capacity",
     nvidia_gpu_encoder_capacity_hevc_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "%" },
#if defined(CUDART_VERSION) && CUDART_VERSION >= 12030
    { "encoder_cap_av1",
     "nvml", "Video encoder AV1 capacity",
     nvidia_gpu_encoder_capacity_av1_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "%" },
#endif
    { "encoder_usage",
     "nvml", "Video encoder usage",
     nvidia_gpu_encoder_usage_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "%" },
    { "gom_cur",
     "nvml", "Current GPU operation mode (all_on, compute_only, graphics_only)",
     nvidia_gpu_gom_cur_getter, nvidia_gpu_gom_setter,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "gom_pend",
     "nvml", "Pending (after reboot) GPU operation mode (all_on, compute_only, graphics_only)",
     nvidia_gpu_gom_pend_getter, nvidia_gpu_gom_setter,
     DEVICE_TYPE_NVIDIA_GPU, NULL },
    { "jpg_usage",
     "nvml", "JPG usage",
     nvidia_gpu_jpg_usage_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "%" },
    { "dram_bus_width",
     "nvml", "DRAM bus width",
     nvidia_gpu_dram_bus_width_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "Bit" },
    { "multi_gpu",
     "nvml", "Multi GPU board",
     nvidia_gpu_multi_gpu_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "bool" },
    { "temp_gpu_cur",
     "nvml", "Current GPU temperature",
     nvidia_gpu_temp_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "degrees C" },
    { "temp_thresh_shut",
     "nvml", "Shutdown temperature threshold",
     nvidia_gpu_temp_thresh_shut_getter, nvidia_gpu_temp_thresh_shut_setter,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "degrees C" },
    { "temp_thresh_slow",
     "nvml", "Slowdown Temperature threshold",
     nvidia_gpu_temp_thresh_slow_getter, nvidia_gpu_temp_thresh_slow_setter,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "degrees C" },
    { "temp_thresh_mem_max",
     "nvml", "Maximum memory temperature threshold",
     nvidia_gpu_temp_thresh_mem_max_getter, nvidia_gpu_temp_thresh_mem_max_setter,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "degrees C" },
    { "temp_thresh_gpu_max",
     "nvml", "Maximum GPU temperature threshold",
     nvidia_gpu_temp_thresh_gpu_max_getter, nvidia_gpu_temp_thresh_gpu_max_setter,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "degrees C" },
#if defined(CUDART_VERSION) && CUDART_VERSION >= 11020
    { "temp_thresh_acou_min",
     "nvml", "Minimum acoustic temperature threshold",
     nvidia_gpu_temp_thresh_acou_min_getter, nvidia_gpu_temp_thresh_acou_min_setter,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "degrees C" },
    { "temp_thresh_acou_cur",
     "nvml", "Current acoustic temperature threshold",
     nvidia_gpu_temp_thresh_acou_cur_getter, nvidia_gpu_temp_thresh_acou_cur_setter,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "degrees C" },
    { "temp_thresh_acou_max",
     "nvml", "Maximum acoustic temperature threshold",
     nvidia_gpu_temp_thresh_acou_max_getter, nvidia_gpu_temp_thresh_acou_max_setter,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "degrees C" },
#endif
#if defined(CUDART_VERSION) && CUDART_VERSION >= 12060
    { "temp_thresh_gps_cur",
     "nvml", "Current GPS temperature threshold",
     nvidia_gpu_temp_thresh_gps_cur_getter, nvidia_gpu_temp_thresh_gps_cur_setter,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "degrees C" },
#endif
    { "ofa_usage",
     "nvml", "Optical Flow Accelerator usage",
     nvidia_gpu_ofa_usage_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "%" },
    { "energy",
     "nvml", "Energy consumed since driver reload",
     nvidia_gpu_energy_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "J" },
    { "gpu_usage",
     "nvml", "GPU usage",
     nvidia_gpu_gpu_usage_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "%" },
    { "dram_bw_usage",
     "nvml", "DRAM bandwidth usage",
     nvidia_gpu_dram_usage_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "%" },
    { "gpu_perf_pol_power",
     "nvml", "Time:duration below app clock due to power limit",
     nvidia_gpu_policy_time_power_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "us:ns" },
    { "gpu_perf_pol_therm",
     "nvml", "Time:duration below app clock due to thermal limit",
     nvidia_gpu_policy_time_therm_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "us:ns" },
    { "gpu_perf_pol_syncboost",
     "nvml", "Time:duration below app clock due to sync boost",
     nvidia_gpu_policy_time_sync_boost_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "us:ns" },
    { "gpu_perf_pol_boardlimit",
     "nvml", "Time:duration below app clock due to board limit",
     nvidia_gpu_policy_time_board_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "us:ns" },
    { "gpu_perf_pol_lowutil",
     "nvml", "Time:duration below app clock due to low utilization",
     nvidia_gpu_policy_time_lowutil_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "us:ns" },
    { "gpu_perf_pol_reliab",
     "nvml", "Time:duration below app clock due to board reliability limit",
     nvidia_gpu_policy_time_rel_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "us:ns" },
    { "gpu_perf_pol_totalapp",
     "nvml", "Total time:duration below app clock",
     nvidia_gpu_policy_time_total_app_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "us:ns" },
    { "gpu_perf_pol_totalbase",
     "nvml", "Total time:duration below base clock",
     nvidia_gpu_policy_time_total_base_getter, NULL,
     DEVICE_TYPE_NVIDIA_GPU, NULL,
     "us:ns" },
};
