...
int power_init(int cpuId)
{
    ...
    case P6_FAMILY:
        ...
        break;
    case ZEN_FAMILY:
        if (cpuid_info.model == ZEN_RYZEN || cpuid_info.model == ZENPLUS_RYZEN || cpuid_info.model == ZENPLUS_RYZEN2 || cpuid_info.model == ZEN2_RYZEN || cpuid_info.model == ZEN2_RYZEN2 || cpuid_info.model == ZEN2_RYZEN3 || cpuid_info.model == ZEN3_RYZEN || cpuid_info.model == ZEN3_RYZEN2 || cpuid_info.model == ZEN3_RYZEN3 || cpuid_info.model == ZEN3_EPYC_TRENTO) {
            cpuid_info.turbo = 0;
            power_info.hasRAPL = 1;
            numDomains = 2;
    ...
    if (power_info.hasRAPL) {
        ...
        if (err == 0) {
            ...
            } else if (cpuid_info.family == P6_FAMILY && ((cpuid_info.model == SAPPHIRERAPIDS) || (cpuid_info.model == GRANITERAPIDS) || (cpuid_info.model == SIERRAFORREST))) {
