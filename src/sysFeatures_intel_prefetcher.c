...
static _SysFeature intel_cpu_prefetch_features[] = {
    { "l2_hwpf",
     "prefetch", "L2 Hardware Prefetcher",
     intel_cpu_l2_hwpf_getter,   intel_cpu_l2_hwpf_setter,
     DEVICE_TYPE_HWTHREAD, intel_cpu_l2_hwpf_register_test,
     NULL },
    { "l2_adj_pf",
     "prefetch", "L2 Adjacent Cache Line Prefetcher",
     intel_cpu_l2_adj_pf_getter, intel_cpu_l2_adj_pf_setter,
     DEVICE_TYPE_HWTHREAD, intel_cpu_l2_hwpf_register_test,
     NULL },
    { "l1_dcu",
     "prefetch", "DCU Hardware Prefetcher",
     intel_cpu_l1_dcu_getter,    intel_cpu_l1_dcu_setter,
     DEVICE_TYPE_HWTHREAD, intel_cpu_l2_hwpf_register_test,
     NULL },
    { "l1_dcu_ip",
     "prefetch", "DCU IP Prefetcher",
     intel_cpu_l1_dcu_ip_getter, intel_cpu_l1_dcu_ip_setter,
     DEVICE_TYPE_HWTHREAD, intel_cpu_l2_hwpf_register_test,
     NULL },
...
static _SysFeature intel_8f_cpu_features[] = {
    { "l2_multipath_pf",
     "prefetch", "L2 Adaptive Multipath Probability Prefetcher",
     intel_cpu_l2_multipath_pf_getter, intel_cpu_l2_multipath_pf_setter,
     DEVICE_TYPE_HWTHREAD, intel_cpu_l2_hwpf_register_test,
     NULL }
};
...
static _SysFeature intel_knl_cpu_prefetch_features[] = {
    { "l2_hwpf",
     "prefetch", "L2 Hardware Prefetcher",
     intel_knl_l2_hwpf_getter, intel_knl_l2_hwpf_setter,
     DEVICE_TYPE_HWTHREAD, intel_cpu_l2_hwpf_register_test,
     NULL },
    { "l1_dcu",
     "prefetch", "DCU Hardware Prefetcher",
     intel_knl_l1_dcu_getter,  intel_knl_l1_dcu_setter,
     DEVICE_TYPE_HWTHREAD, intel_cpu_l2_hwpf_register_test,
     NULL },
};
...
static _SysFeature intel_core2_cpu_prefetch_features[] = {
    { "hwpf",
     "prefetch", "Hardware prefetcher operation on streams of data",
     intel_core2_l2_hwpf_getter,   intel_core2_l2_hwpf_setter,
     DEVICE_TYPE_HWTHREAD, intel_core2_l2_hwpf_register_test,
     NULL },
    { "adj_pf",
     "prefetch", "Adjacent Cache Line Prefetcher",
     intel_core2_l2_adjpf_getter,  intel_core2_l2_adjpf_setter,
     DEVICE_TYPE_HWTHREAD, intel_core2_l2_hwpf_register_test,
     NULL },
    { "l1_dcu",
     "prefetch", "DCU L1 data cache prefetcher",
     intel_core2_l1_dcu_getter,    intel_core2_l1_dcu_setter,
     DEVICE_TYPE_HWTHREAD, intel_core2_l2_hwpf_register_test,
     NULL },
    { "l1_dcu_ip",
     "prefetch", "DCU IP Prefetcher",
     intel_core2_l1_dcu_ip_getter, intel_core2_l1_dcu_ip_setter,
     DEVICE_TYPE_HWTHREAD, intel_core2_l2_hwpf_register_test,
     NULL },
};
...
static _SysFeature intel_cpu_ida_features[] = {
    ...
    { "ida",
     "prefetch", "Intel Dynamic Acceleration",
     intel_core2_ida_getter, intel_core2_ida_setter,
     DEVICE_TYPE_HWTHREAD, intel_core2_ida_tester,
     NULL },
};
