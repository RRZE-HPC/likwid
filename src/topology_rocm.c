...
#define DECLAREHIPFUNC(funcname, funcsig)                                                          \
    hipError_t HIPWEAK funcname funcsig;                                                           \
    hipError_t(*funcname##TopoPtr) funcsig;
...
#define DLSYM_AND_CHECK(dllib, name)                                                               \
    ...
    res = (*hipGetProcAddressTopoPtr)("hipGetDeviceProperties",
