                                                    ...
                                                    MAKE_DIMM_FEATURES(0xC)
                                                        MAKE_DIMM_FEATURES(0xD)
                                                            MAKE_DIMM_FEATURES(0xE)
                                                                MAKE_DIMM_FEATURES(0xF) { "pkg_freq_limit", "hsmp", "Current socket frequency limit", amd_hsmp_sock_freq_limit_freq_getter, NULL, DEVICE_TYPE_SOCKET, amd_hsmp_test_ver5, "MHz" },
                    ...
                    MAKE_XGMI_FEATURE(g0)
                        MAKE_XGMI_FEATURE(g1)
                            MAKE_XGMI_FEATURE(g2)
                                MAKE_XGMI_FEATURE(g3) { "pkg_gmi3_link_width", "hsmp", "Set minimum and maximum GMI3 link width (bitfield integer: min[15:8], max[7:0], 0 = quarter, 1 = half, 2 = full)", NULL, amd_hsmp_gmi3_width_setter, DEVICE_TYPE_SOCKET, amd_hsmp_test_ver5 },
