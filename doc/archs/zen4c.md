...
<LI> \ref ZEN4C_UMC "Unified memory controller counters"</LI>
</UL>
...
<P>The AMD&reg; Zen4c microarchitecture provides additional Uncore counters at the unified memory controllers (UMC). There are up to 12 memory controllers with up to 5 counters each as the system provides 64 registers in total for all. The exact configuration is system dependent and read at runtime.</P>
